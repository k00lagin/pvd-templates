...
>
	...
	<xsl:variable
		name="statementCodes"
		select="'-558610000000-558610100000-558610300000-558610400000-558610500000-558610600000-558610700000-558620000000-558620100000-558620200000-558620300000-558620400000-558620500000-558610800000-558620900000-558621000000-558621100000-558101140000'"
	/>
	<xsl:variable
		name="requestListInfo"
		select="//tns:EGRNRequestListCV/tns:requestDetails/tns:requestListInfo"
	/>
	<!-- Земельный участок -->
	...
	<xsl:variable
		name="oother"
		select="//tns:EGRNRequestListCV/tns:declarant/subj:other"
	/>
	<!-- Представители 1го уровня -->
	<xsl:variable
		name="orperson"
		select="tns:EGRNRequestListCV/tns:declarant/subj:representative/subj:subject/subj:person"
	/>
	<xsl:variable
		name="orpersonPrevileg"
		select="tns:EGRNRequestListCV/tns:declarant/subj:representative/subj:subject/subj:previligedPerson"
	/>
	<xsl:variable
		name="ororganization"
		select="//tns:EGRNRequestListCV/tns:declarant/subj:representative/subj:subject/subj:organization"
	/>
	<xsl:variable
		name="orother"
		select="//tns:EGRNRequestListCV/tns:declarant/subj:representative/subj:subject/subj:other"
	/>
	<!-- Представитель 2го уровня. (Предс-ль правообладателя - ЮЛ1 и представитель этого ЮЛ1 - ФЛ)-->
	<xsl:variable
		name="ororganizationPer"
		select="//tns:EGRNRequestListCV/tns:declarant/subj:representative/subj:subject/subj:representative/subj:subject/subj:person"
	/>
	<xsl:variable
		name="ororganizationPerPrevileg"
		select="//tns:EGRNRequestListCV/tns:declarant/subj:representative/subj:subject/subj:representative/subj:subject/subj:previligedPerson"
	/>
	<!-- ===== Новое формирование представителей ===== -->
	<xsl:variable
		name="tempRepresent"
		select="(//tns:EGRNRequestListCV/descendant::subj:representative/subj:subject)"
	/>
	<xsl:variable
		name="tempRepFiltred"
	...
	<xsl:variable
		name="appDocs"
		select="//tns:EGRNRequestListCV/tns:header/stCom:appliedDocument"
	/>
	...
	<xsl:variable
		name="nameOrganInner"
		select="tns:EGRNRequestListCV/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:regRightAuthority"
	/>
...
input[type="reset"],input[type="submit"] {
			...
			<div class="row">
				<div class="cell lh-middle center w260 wrap">
					<div class="ul center bottompad5">
						1. Запрос о предоставлении перечня объектов недвижимости, подлежащих
				...
				<div class="cell title w380">
					<div class="sidepad wrap">
						...
						<div class="lh-small">
							...
							<xsl:if
								test="normalize-space($userFIO) and normalize-space(//tns:EGRNRequestListCV/@_id)"
							>
								<span
							...
							<xsl:if
								test="not(normalize-space($userFIO)) or not(normalize-space(//tns:EGRNRequestListCV/@_id))"
							>
						...
						<div class="">
							<xsl:if test="$typeOrgan = 'MFC'">
								<xsl:if
									test="normalize-space($creationDate) and normalize-space(//tns:EGRNRequestListCV/@_id)"
								>
									<span>2.4 дата </span>
									<span
										class="inlineblock bottomborder sidepad notoppad lh-small bold"
								...
								<xsl:if
									test="not(normalize-space($creationDate)) or not(normalize-space(//tns:EGRNRequestListCV/@_id))"
								>
									<span
										>2.4 дата &laquo;_____&raquo; ___________________ _______
							...
							<xsl:if test="$typeOrgan = 'PVD'">
								<xsl:if
									test="normalize-space($when) and normalize-space(//tns:EGRNRequestListCV/@_id)"
								>
									<span>2.4 дата </span>
									<span
										class="inlineblock bottomborder sidepad notoppad lh-small bold"
								...
								<xsl:if
									test="not(normalize-space($when)) or not(normalize-space(//tns:EGRNRequestListCV/@_id))"
								>
									<span
										>2.4 дата &laquo;_____&raquo; ___________________ _______
										г., время ______ ч., ______ мин.</span
						...
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad wrap">
									Прошу предоставить перечень объектов недвижимости, подлежащих
									государственной кадастровой оценке:
								</div>
							</div>
							<!-- Наименование СРФ -->
								...
								<div class="row">
									<div class="table tablemargin">
										<div class="row">
											...
											<div class="cell leftpad wrap">
												<xsl:text
													>наименование субъекта Российской Федерации, в
													границах которого расположены объекты недвижимости,
													подлежащие государственной кадастровой оценке:
												</xsl:text>
												<span class="bold">
													<xsl:call-template name="createAddressTemplate">
														<xsl:with-param
															name="pathToAddress"
															select="$requestListInfo/tns:region"
														/>
													</xsl:call-template>
												</span>
											</div>
								...
								<div class="row">
									<div class="table tablemargin">
										<div class="row">
											...
											<div class="cell leftpad wrap">
												<xsl:text
													>наименование муниципального образования, в границах
													которого расположены объекты недвижимости, подлежащие
													государственной кадастровой оценке, в случае если
													государственной кадастровой оценке подлежат объекты
													недвижимости, расположенные на территории не всех
													муниципальных образований, входящих в состав субъекта
								...
								<div class="row">
									<div class="table tablemargin">
										...
										<div class="table tablemargin">
											<div class="cell leftpad wrap">
												<xsl:text
													>вид (виды) объектов недвижимости, подлежащих
													государственной кадастровой оценке:</xsl:text
												>
											</div>
											<xsl:variable
												name="thisParcel"
												select="$requestListInfo/tns:objectTypes/tns:parcel"
											/>
											<xsl:for-each
												select="$requestListInfo/tns:objectTypes/tns:objectType"
											>
													...
													<div class="table tablemargin">
														...
														<div class="cell leftpad wrap bold">
															<xsl:choose>
																...
																>
																	<xsl:text
																		>единые недвижимые комплексы</xsl:text
																	>
																</xsl:when>
																<xsl:when
														...
														<div class="table tablemargin">
															...
															<xsl:if test="$thisParcel/tns:category">
																<div class="row">
																	<div class="cell leftpad wrap">
																		<xsl:text
																			>категория (категории) земель, в случае
																			если объектами недвижимости, подлежащими
																			государственной кадастровой оценке,
																			являются земельные участки</xsl:text
																		>
																	</div>
																</div>
															</xsl:if>
			...
			<div class="table">
				<div class="row">
					...
					<div class="cell leftpad">
						<xsl:text
							>Дата, по состоянию на которую необходимо сформировать перечень:
						</xsl:text>
						<span class="bold">
	...
	<xsl:template name="point31person">
		...
		<xsl:variable
			name="subjDoc"
			select="//tns:EGRNRequestListCV/tns:header/stCom:appliedDocument/node()[@_id=$thisPerson/subj:idDocumentRef/@documentID]"
		/>
		...
		<xsl:if test="$mode1 = 'representative' ">
			...
			<xsl:if test="$tmpDocNode/parent::node()/following-sibling::node()">
				...
				<!--span class="bold"-->
				<xsl:for-each
					select="//tns:EGRNRequestListCV/tns:header/stCom:appliedDocument/node()[@_id=$tmpDocNode/parent::node()/following-sibling::node()/@documentID]"
				>
					<xsl:call-template name="documentTemplate">
						<xsl:with-param name="thisDocument" select="." />
				...
				<xsl:if test="$thisPerson/subj:previousData/subj:idDocumentRef">
					...
					>
						...
						<xsl:call-template name="documentTemplate">
							<xsl:with-param
								name="thisDocument"
								select="//tns:EGRNRequestListCV/tns:header/stCom:appliedDocument/node()[@_id=$prevDocId]"
							/>
							<xsl:with-param name="modeIdDoc" select="'idDoc'" />
						</xsl:call-template>
						<xsl:if test="position() != last()">
	...
	<xsl:template name="point32organization">
		...
		<xsl:if test="$thisOrganization/subj:name | $thisOrganization/tns:Name">
			<span class="bold">
				<xsl:value-of
					select="$thisOrganization/subj:name | $thisOrganization/tns:Name"
				/>
				<xsl:if
						...
						<div class="table tablemargin">
							<div class="row">
								<div class="table tablemargin">
									<div class="cell leftpad wrap">
										<xsl:text
											>Сведения о заявителе (заказчике работ по определению
											кадастровой стоимости):</xsl:text
										>
									</div>
								</div>
							</div>
	...
	<xsl:template name="point7">
		<xsl:variable
			name="receiveMethod"
			select="//tns:EGRNRequestListCV/tns:deliveryDetails/stCom:resultDeliveryMethod/stCom:recieveResultTypeCode"
		/>
								...
								<div class="table tablemargin">
									...
									<xsl:if test="$receiveMethod = 'postMail'">
										<div class="cell leftpad wrap">
											...
											<xsl:if
												test="//tns:EGRNRequestListCV/tns:deliveryDetails/stCom:resultDeliveryMethod/stCom:postAddress"
											>
												<span class="bold">
													<xsl:call-template name="createAddressTemplate">
														<xsl:with-param
															name="pathToAddress"
															select="//tns:EGRNRequestListCV/tns:deliveryDetails/stCom:resultDeliveryMethod/stCom:postAddress"
														/>
													</xsl:call-template>
												</span>
											</xsl:if>
									...
									<xsl:if test="$receiveMethod = 'eMail'">
										<div class="cell leftpad wrap">
											...
											<xsl:if
												test="//tns:EGRNRequestListCV/tns:deliveryDetails/stCom:resultDeliveryMethod/stCom:eMail"
											>
												<span class="bold">
													<xsl:value-of
														select="//tns:EGRNRequestListCV/tns:deliveryDetails/stCom:resultDeliveryMethod/stCom:eMail"
													/>
												</span>
											</xsl:if>
										</div>
	...
	<xsl:template name="point9">
		<xsl:variable
			name="note9"
			select="//tns:EGRNRequestListCV/tns:requestDetails/tns:note/com:text"
		/>
		<xsl:if test="$note9">
			<div class="table">
				<div class="row">
