...
xmlns:doc="http://rosreestr.ru/services/v0.26/commons/Documents">
	...
	<xsl:variable name="requestCopyAction" select="//tns:EGRNRequest/tns:requestDetails/tns:requestCopyAction"/>
...
input[type="reset"],input[type="submit"]{-webkit-appearance:button;cursor:pointer}button[disabled],html input[disabled]{cursor:default}button::-moz-focus-inner,input::-moz-focus-inner{border:0;padding:0}input{line-height:normal}input[type="checkbox"],input[type="radio"]{box-sizing:border-box;padding:0}input[type="number"]::-webkit-inner-spin-button,input[type="number"]::-webkit-outer-spin-button{height:auto}input[type="search"]{-webkit-appearance:textfield;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;box-sizing:content-box}input[type="search"]::-webkit-search-cancel-button,input[type="search"]::-webkit-search-decoration{-webkit-appearance:none}fieldset{border:1px solid silver;margin:0 2px;padding:.35em .625em .75em}legend{border:0;padding:0}textarea{overflow:auto}optgroup{font-weight:700}table{border-collapse:collapse;border-spacing:0}td,th{padding:0}
		...
		<div class="table">
			<div class="row">
				<div class="cell lh-middle center w260 wrap">
					<div class="ul center bottompad5">1. Запрос о предоставлении копии документа, на основании которого сведения об объекте недвижимости внесены в Единый государственный реестр недвижимости, или копий документов, помещенных в реестровое дело</div>
				...
				<div class="row">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad">Прошу предоставить копию помещенного в реестровое дело:</div>
							</div>
								<xsl:if test="$requestCopyAction/tns:object/tns:boundaryObjectRecordNumber">
									<div class="row">
										<div class="table tablemargin">
											...
											<div class="cell leftpad wrap">
												<xsl:text>о зоне, публичном сервитуте, территории или границе с реестровым номером: </xsl:text>
												<span class="bold">
													<xsl:value-of select="$requestCopyAction/tns:object/tns:boundaryObjectRecordNumber"/>
												</span>
											</div>
										</div>
									</div>
									<!--Если указано "все документы" -->
									<xsl:if test="$requestCopyAction/tns:allDocument">
										<div class="row">
											<div class="table tablemargin">
												...
												<div class="cell leftpad wrap">
													<xsl:text>документ, на основании которого сведения о зоне, публичном сервитуте, территории или границах внесены в Единый государственный реестр недвижимости </xsl:text>
													<span class="bold">
									...
									<!--Если есть раздел tns:document - в графе 6 указываем реквизиты через ;-->
									<xsl:if test="$requestCopyAction/tns:document">
										<div class="row">
											<div class="table tablemargin">
												<div class="cell leftpad w40"> </div>
												<div class="cell center w40">
												...
												<div class="cell leftpad wrap">
													<xsl:text>документ, на основании которого сведения о зоне, публичном сервитуте, территории или границах внесены в Единый государственный реестр недвижимости </xsl:text>
													<span class="bold">
														<xsl:for-each select="$requestCopyAction/tns:document">
								...
								<xsl:if test="$requestCopyAction/tns:object/tns:objectCadastralNumber">
									<div class="row">
										<div class="table tablemargin">
											<div class="cell center w40 bold">
												<xsl:text>V</xsl:text>
											...
											<div class="cell leftpad ">
												<xsl:text>об объекте недвижимости с кадастровым номером: </xsl:text>
												<span class="bold">
													<xsl:value-of select="$requestCopyAction/tns:object/tns:objectCadastralNumber"/>
												</span>
											</div>
										</div>
									</div>
									...
									<xsl:if test="$requestCopyAction/tns:allDocument">
										<div class="row">
											<div class="table tablemargin">
												...
												<div class="cell leftpad wrap">
													<xsl:text>иного документа, на основании которого сведения об объекте недвижимости внесены в Единый государственный реестр недвижимости, иного документа, помещенного в реестровое дело </xsl:text>
													<span class="bold">
														<xsl:text>все</xsl:text>
													</span>
												</div>
									...
									<!--Если есть раздел tns:document - заполняем в соответствии с типом-->
									<xsl:if test="$requestCopyAction/tns:document">
										<!-- Если документов больше одного - все их реквизиты идут в графу аналогичную для случая "все"-->		
										<xsl:if test="count($requestCopyAction/tns:document)&gt;1">
											<div class="row">
												<div class="table tablemargin">
													<div class="cell leftpad w40"> </div>
													<div class="cell center w40">
										...
										<!--Если документ один, то выводим по таблице соответствий -->
										<xsl:if test="count($requestCopyAction/tns:document)=1">
											<xsl:for-each select="$requestCopyAction/tns:document">
												<div class="row">
													<div class="table tablemargin">
														...
														<div class="cell leftpad wrap">
															<xsl:call-template name="documentMatchTable">
																<xsl:with-param name="docCode" select="doc:requestDocumentType"/>
															</xsl:call-template>
															<xsl:text>&nbsp;</xsl:text>
															<span class="bold">
																	<xsl:call-template name="showDocumentData">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							<div class="row">
								<div class="table tablemargin">
									<div class="cell leftpad  wrap">
										<xsl:text>Сведения о заявителе (физическом лице, арбитражном управляющем, судебном приставе-исполнителе, нотариусе):</xsl:text>
									</div>
								</div>
							</div>
							<div class="row">
	...
	<xsl:template name="point311">
		...
		<div class="table tablemargin">
			<div class="row">
				<!--div class="cell leftpad w40">3.1.1</div-->
				<div class="cell clear">
					<div class="table tablemargin">
						<!--div class="row">
							<div class="table">
								<div class="cell leftpad wrap">
									<xsl:text>физические лицо (в том числе нотариус, судебный пристав-исполнитель):</xsl:text>
								</div>
							</div>
						</div-->
	...
	<xsl:template name="point312">
		...
		<!--div class="table">
			<div class="row"-->
				<!--div class="cell leftpad w40">3.1.2</div-->
				<!--div class="cell clear">
					<div class="table tablemargin"-->
						<!--div class="row">
							<div class="table">
								<div class="cell leftpad wrap">
									<xsl:text>юридическое лицо, орган государственной власти, орган местного самоуправления:</xsl:text>
								</div>
							</div>
						</div-->
						<!-- Цикличность возможно избыточна-->
	...
	<xsl:template name="point31person">
		...
		<div class="row">
			<div class="table tablemargin">
				<div class="cell wrap">
					<xsl:text>Вид документа, удостоверяющего личность </xsl:text>
					<span class="bold">
		...
		<xsl:if test="$subjDoc/doc:series or $subjDoc/doc:number">
			<div class="row">
				<div class="table tablemargin">
					<div class="cell wrap">
						<xsl:text>Серия и номер документа, удостоверяющего личность </xsl:text>
		...
		<xsl:if test="$subjDoc/doc:issueDate">
			<div class="row">
				<div class="table tablemargin">
					<div class="cell wrap">
						<xsl:text>Дата выдачи документа </xsl:text>
						<span class="bold">
							<xsl:if test="$subjDoc/doc:issueDate">
								<xsl:call-template name="DateStr">
		...
		<xsl:if test="$thisPerson/subj:contactInfo  or (($mode1 != 'representative') and $thisPerson/subj:snils)" >
			<div class="row">
				<div class="table tablemargin">
					<div class="cell wrap">
						<xsl:if test="$thisPerson/subj:contactInfo/subj:phoneNumber">
							...
							<span class="bold">
								...
								<xsl:if test="$thisPerson/subj:contactInfo/subj:postalAddress or $thisPerson/subj:contactInfo/subj:email">
									<xsl:text>, </xsl:text>
								</xsl:if>
							</span>
						</xsl:if>
                        ...
                        <xsl:if test="($mode1 != 'representative') and $thisPerson/subj:snils">
                            <xsl:text>СНИЛС </xsl:text>
                            <span class="bold">
                                <xsl:value-of select="$thisPerson/subj:snils"/>
                            </span>
		...
		<div class="row">
			<div class="table tablemargin">
				<div class="cell wrap">
					...
					<xsl:if test="$thisOrganization/subj:nativeForeignParams/subj:nativeOrgParams/subj:ogrn">
						<xsl:text>, ОГРН </xsl:text>
						<span class="bold">
							<xsl:value-of select="$thisOrganization/subj:nativeForeignParams/subj:nativeOrgParams/subj:ogrn"/>
						</span>
					</xsl:if>
                    <xsl:if test="$thisOrganization/subj:ogrn">
                        <xsl:text>, ОГРН </xsl:text>
                        <span class="bold">
                            <xsl:value-of select="$thisOrganization/subj:ogrn"/>
                        </span>
                    </xsl:if>
					...
					<xsl:if test="$thisOrganization/subj:nativeForeignParams/subj:nativeOrgParams/subj:regDate">
					...
					<xsl:if test="$thisOrganization/subj:nativeForeignParams/subj:nativeOrgParams/subj:inn">
						<xsl:text> ИНН </xsl:text>
						<span class="bold">
							<xsl:value-of select="$thisOrganization/subj:nativeForeignParams/subj:nativeOrgParams/subj:inn"/>
						</span>
					</xsl:if>
                    ...
                    <xsl:if test="$thisOrganization/subj:inn">
                        <xsl:text> ИНН </xsl:text>
                        <span class="bold">
                            <xsl:value-of select="$thisOrganization/subj:inn"/>
                        </span>
                    </xsl:if>
		...
		<xsl:if test="//tns:EGRNRequest/tns:statementAgreements">
			<div class="table">
				<div class="row">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							<xsl:if test="//tns:EGRNRequest/tns:statementAgreements/stCom:qualityOfServiceAgreement">
								<div class="row">
									<div class="table tablemargin">
										<div class="cell center w40">
											<b>V</b>
	...
	<xsl:template name="point11">
		<xsl:variable name="note11" select="//tns:EGRNRequest/tns:requestDetails/tns:note/com:text"/>
		<xsl:if test="$note11">
			<div class="table">
				<div class="row">
				...
				<div class="row">
					<div class="table tablemargin">
						...
						<div class="cell left wrap bold">
							...
							<!-- TODO Здесь ресализовать анализ типа документа и для платежного написать свой вывод. или все усложнить в выводе showDocumentData через  параметр -->
							<xsl:call-template name="showDocumentData">
								<xsl:with-param name="thisDocument" select="$thisDocument"/>
								<xsl:with-param name="modeIdDoc" select="$modeIdDoc"/>
							</xsl:call-template>
...
<xsl:value-of select="($thisDocument/doc:series)"/-->
	...
	<xsl:template name="documentMatchTable">
		...
		<xsl:if test="$docCode = 561010016000">документа, на основании которого сведения о зоне, публичном сервитуте, территории или границах внесены в Единый государственный реестр недвижимости</xsl:if>
	</xsl:template>
	...
	<xsl:template name="IOF">
		<xsl:param name="person"/>
		<xsl:if test="string($person/stCom:firstname)">
			<xsl:call-template name="upperCase">
				<xsl:with-param name="text">
					<xsl:value-of select="substring($person/stCom:firstname,1,1)"/>
				</xsl:with-param>
			</xsl:call-template>
			<xsl:text>.</xsl:text>
		</xsl:if>
		<xsl:if test="string($person/stCom:patronymic)">
			<xsl:call-template name="upperCase">
				<xsl:with-param name="text">
					<xsl:value-of select="substring($person/stCom:patronymic,1,1)"/>
				</xsl:with-param>
			</xsl:call-template>
			<xsl:text>. </xsl:text>
		</xsl:if>
		<xsl:if test="string($person/stCom:surname)">
			<xsl:call-template name="upperCase">
				<xsl:with-param name="text">
					<xsl:value-of select="substring($person/stCom:surname,1,1)"/>
				</xsl:with-param>
			</xsl:call-template>
			<xsl:value-of select="substring($person/stCom:surname,2)"/>
		</xsl:if>
	</xsl:template>
