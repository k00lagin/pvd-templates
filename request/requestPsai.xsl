...
>
	...
	<xsl:variable
		name="requestAInfo"
		select="//tns:EGRNRequest/tns:requestDetails/tns:requestAnalyticalInformation"
	/>
	<!-- Земельный участок -->
...
input[type="reset"],input[type="submit"] {
			...
			<div class="row">
				<div class="cell lh-middle center w260 wrap">
					<div class="ul center bottompad5">
						1. Запрос о предоставлении аналитической информации, полученной на
	...
	<xsl:template name="point1_1">
		<xsl:variable
			name="AInfo"
			select="$requestAInfo/analytic:analyticalInformation"
		/>
		<xsl:if test="$AInfo">
			<div class="table">
				<div class="row">
						...
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad">
									Прошу предоставить аналитическую информацию:
								</div>
							</div>
							<xsl:choose>
										...
										<div class="table tablemargin">
											...
											<div class="table tablemargin">
												<div class="cell leftpad wrap">
													<xsl:text
														>об осуществлении регистрационных действий
														с:</xsl:text
													>
												</div>
												<div class="row">
													<div class="table tablemargin">
														...
														<div class="cell leftpad wrap">
															<xsl:choose>
																<xsl:when
																	test="$AInfo/analytic:registrationActionsObject/analytic:objectPurposeResidential"
																>
																	<xsl:text
																		>объектами недвижимости жилого
																		назначения</xsl:text
																	>
																</xsl:when>
																<xsl:when
																	test="$AInfo/analytic:registrationActionsObject/analytic:objectPurposeUninhabited"
																>
																	<xsl:text
																		>объектами недвижимости нежилого
																		назначения</xsl:text
																	>
																</xsl:when>
																<xsl:when
																	test="$AInfo/analytic:registrationActionsObject/analytic:underConstruction"
																>
																	<xsl:text
																...
																<xsl:when
																	test="$AInfo/analytic:registrationActionsObject/analytic:propertyComplex"
																>
																	<xsl:text
																		>предприятиями как имущественными
																		комплексами</xsl:text
																	>
																</xsl:when>
																<xsl:when
																	test="$AInfo/analytic:registrationActionsObject/analytic:unifiedRealEstateComplex"
																>
																	<xsl:text
																		>едиными недвижимыми комплексами</xsl:text
																	>
																</xsl:when>
																<xsl:when
																	test="$AInfo/analytic:registrationActionsObject/analytic:land"
																>
												...
												<div class="row">
													<div class="table tablemargin">
														...
														<div class="cell leftpad wrap">
															<xsl:choose>
																<xsl:when
																	test="$AInfo/analytic:numberAreaFormedLand/analytic:surveyProjectTerritory"
																>
																	<xsl:text
																		>в соответствии с утвержденным проектом
																		межевания территории</xsl:text
																	>
																</xsl:when>
																<xsl:when
																	test="$AInfo/analytic:numberAreaFormedLand/analytic:surveyProjectLand"
																>
																	<xsl:text
																...
																<xsl:when
																	test="$AInfo/analytic:numberAreaFormedLand/analytic:schemaParcelsInBlock"
																>
																	<xsl:text
																		>в соответствии со схемой расположения
																		земельного участка или земельных участков на
																		кадастровом плане территории</xsl:text
																	>
																</xsl:when>
																<xsl:when
																	test="$AInfo/analytic:numberAreaFormedLand/analytic:forestParcel"
																>
																	<xsl:text
																		>в соответствии с проектной документацией
																		лесных участков</xsl:text
																	>
																</xsl:when>
																<xsl:when
																	test="$AInfo/analytic:numberAreaFormedLand/analytic:schemaParcelsOnPKK"
																>
																	<xsl:text
																		>в соответствии со схемой размещения
																		земельного участка на публичной кадастровой
																		карте</xsl:text
																	>
																</xsl:when>
															</xsl:choose>
									...
									<div class="row">
										<div class="table tablemargin">
											...
											<div class="table tablemargin">
												<div class="cell leftpad wrap">
													<xsl:text
														>об общем количестве и площади земельных участков,
														относящихся к:</xsl:text
													>
												</div>
												<div class="row">
													<div class="table tablemargin">
														...
														<div class="cell leftpad wrap">
															<xsl:choose>
																<xsl:when
																	test="$AInfo/analytic:numberAreaLand/analytic:categories"
																>
																	<xsl:text
																		>категории (категориям) земель:
																	</xsl:text>
																	<xsl:for-each
																		select="$AInfo/analytic:numberAreaLand/analytic:categories/analytic:category"
																	>
																		<span class="bold">
																			<xsl:call-template
																				name="landCategoryTemplate"
																			>
																				<xsl:with-param
																					name="landCategory"
																					select="."
																...
																<xsl:when
																	test="$AInfo/analytic:numberAreaLand/analytic:landPermittedUses"
																>
																	<xsl:text
																		>виду (видам) разрешенного использования:
																	</xsl:text>
																	<xsl:for-each
																		select="$AInfo/analytic:numberAreaLand/analytic:landPermittedUses/analytic:landPermittedUse"
																	>
																		<span class="bold">
																			<xsl:if test="analytic:landUse">
																				<xsl:call-template
																					name="usageTypeTemplate"
																				>
																					<xsl:with-param
																						name="usageType"
																						select="analytic:landUse"
																					/>
																				</xsl:call-template>
																			</xsl:if>
																			<xsl:if test="analytic:permittedUseText">
																				<xsl:value-of
																					select="analytic:permittedUseText"
																				/>
																			</xsl:if>
																			<xsl:if test="analytic:utilization">
																				<xsl:call-template
																					name="utilizationTemplate"
																				>
																					<xsl:with-param
																						name="utilization"
																						select="analytic:utilization"
																					/>
																				</xsl:call-template>
																			</xsl:if>
																			<xsl:if test="position() != last()">
																...
																<xsl:when
																	test="$AInfo/analytic:numberAreaLand/analytic:categoryAndPermittedUse"
																>
																	...
																	<span class="bold">
																		...
																		>
																			<xsl:with-param
																				name="landCategory"
																				select="$AInfo/analytic:numberAreaLand/analytic:categoryAndPermittedUse/analytic:category"
																			/>
																		</xsl:call-template>
																	</span>

																	<xsl:text
																		>&nbsp; и виду разрешенного использования
																	</xsl:text>
																	<xsl:for-each
																		select="$AInfo/analytic:numberAreaLand/analytic:categoryAndPermittedUse/analytic:landPermittedUse"
																	>
																		<span class="bold">
																			<xsl:if test="analytic:landUse">
																				<xsl:call-template
																...
																<xsl:when
																	test="$AInfo/analytic:numberAreaLand/analytic:transferCategory"
																>
																	<xsl:text
																		>переведенных из категории земель
																	</xsl:text>
																	<span class="bold">
																		<xsl:call-template
																			name="landCategoryTemplate"
																		>
																			<xsl:with-param
																				name="landCategory"
																				select="$AInfo/analytic:numberAreaLand/analytic:transferCategory/analytic:categoryOld"
																			/>
																		</xsl:call-template>
																	</span>
																	...
																	<span class="bold">
																		...
																		>
																			<xsl:with-param
																				name="landCategory"
																				select="$AInfo/analytic:numberAreaLand/analytic:transferCategory/analytic:categoryNew"
																			/>
																		</xsl:call-template>
																	</span>
																</xsl:when>
									...
									<div class="row">
										<div class="table tablemargin">
											...
											<div class="table tablemargin">
												<div class="cell leftpad wrap">
													<xsl:text
														>об объектах недвижимости в разрезе видов объектов
														недвижимости и кадастровой стоимости (большей,
														меньшей или равной заданному значению):
													</xsl:text>
												</div>
												<xsl:if
													test="$AInfo/analytic:objectCost/analytic:objectTypeCode"
												>
													<div class="row">
														<div class="table tablemargin">
															<div class="cell center w40 bold">V</div>
															<div class="cell leftpad wrap">
																...
																<span class="bold">
																	<xsl:call-template
																		name="objectTypeCodeTemplate"
																	>
																		<xsl:with-param
																			name="code"
																			select="$AInfo/analytic:objectCost/analytic:objectTypeCode"
																		/>
																	</xsl:call-template>
																</span>
															</div>
														...
														<div class="table tablemargin">
															...
															<div class="cell leftpad wrap">
																...
																<span class="bold">
																	<xsl:choose>
																		<xsl:when
																			test="$AInfo/analytic:objectCost/analytic:cost/analytic:valueDimensions"
																		>
																			<xsl:call-template name="ValuesBase">
																				<xsl:with-param
																					name="pRoot"
																					select="$AInfo/analytic:objectCost/analytic:cost/analytic:valueDimensions"
																				/>
																			</xsl:call-template>
																		</xsl:when>
																		<xsl:when
																			test="$AInfo/analytic:objectCost/analytic:cost/analytic:value"
																		>
																			<xsl:value-of
																				select="$AInfo/analytic:objectCost/analytic:cost/analytic:value"
																			/>
																		</xsl:when>
																	</xsl:choose>
																</span>
									...
									<div class="row">
										<div class="table tablemargin">
											...
											<div class="table tablemargin">
												<div class="cell leftpad wrap">
													<xsl:text
														>об общем количестве и площади (основной
														характеристике) земельных участков, зданий,
														сооружений, в отношении которых в Едином
														государственном реестре недвижимости отсутствуют
														сведения о категории земель, виде разрешенного
														использования, назначении:</xsl:text
													>
												</div>
												<xsl:if
													test="$AInfo/analytic:physicalProperties/analytic:objectTypeCode"
												>
													<div class="row">
														<div class="table tablemargin">
															<div class="cell center w40 bold">V</div>
															<div class="cell leftpad wrap">
																...
																<span class="bold">
																	...
																	>
																		<xsl:with-param
																			name="code"
																			select="$AInfo/analytic:physicalProperties/analytic:objectTypeCode"
																		/>
																	</xsl:call-template>
																</span>
															</div>
												...
												<div class="row">
													<div class="table tablemargin">
														...
														<div class="cell leftpad wrap">
															<xsl:text
																>характеристика, отсутствующая в Едином
																государственном реестре недвижимости:
															</xsl:text>
															<span class="bold">
																<xsl:choose>
																	<xsl:when
																		test="$AInfo/analytic:physicalProperties/analytic:category"
																	>
																		<xsl:text
																			>сведения о категории земель</xsl:text
																		>
																	</xsl:when>
																	<xsl:when
																		test="$AInfo/analytic:physicalProperties/analytic:permittedUses"
																	>
																		<xsl:text
																			>сведения о виде разрешенного
																			использования</xsl:text
																		>
																	</xsl:when>
																	<xsl:when
																		test="$AInfo/analytic:physicalProperties/analytic:purpose"
																	>
									...
									<div class="row">
										<div class="table tablemargin">
											...
											<div class="table tablemargin">
												<div class="cell leftpad wrap">
													<xsl:text
														>о кадастровых инженерах с указанием видов
														выполняемых работ и результатов профессиональной
														деятельности:</xsl:text
													>
												</div>
												<xsl:if
													test="$AInfo/analytic:cadWorks/analytic:workType"
												>
													<div class="row">
														<div class="table tablemargin">
															<div class="cell center w40 bold">V</div>
															<div class="cell leftpad wrap">
																...
																<span class="bold">
																	<xsl:value-of
																		select="$AInfo/analytic:cadWorks/analytic:workType"
																	/>
																</span>
															</div>
														</div>
												...
												<xsl:if
													test="$AInfo/analytic:cadWorks/analytic:resultCadWorks"
												>
													<div class="row">
														<div class="table tablemargin">
															<div class="cell center w40 bold">V</div>
															<div class="cell leftpad wrap">
																...
																<span class="bold">
																	<xsl:choose>
																		<xsl:when
																			test="$AInfo/analytic:cadWorks/analytic:resultCadWorks/analytic:decisionActions"
																		>
																			<xsl:text
																				>Количество решений об осуществлении
																				государственного кадастрового учета (в
																				том числе кадастрового учета и
																				государственной регистрации прав)
																			</xsl:text>
																			<xsl:call-template name="ValuesBase">
																				<xsl:with-param
																					name="pRoot"
																					select="$AInfo/analytic:cadWorks/analytic:resultCadWorks/analytic:decisionActions"
																				/>
																			</xsl:call-template>
																		</xsl:when>
																		<xsl:when
																			test="$AInfo/analytic:cadWorks/analytic:resultCadWorks/analytic:decisionToSuspend"
																		>
																			<xsl:text
																				>Количество решений о приостановлении
																				осуществления государственного
																				кадастрового учета (в том числе
																			...
																			<xsl:call-template name="ValuesBase">
																				<xsl:with-param
																					name="pRoot"
																					select="$AInfo/analytic:cadWorks/analytic:resultCadWorks/analytic:decisionToSuspend"
																				/>
																			</xsl:call-template>
																		</xsl:when>
																		<xsl:when
																			test="$AInfo/analytic:cadWorks/analytic:resultCadWorks/analytic:decisionToRefuse"
																		>
																			<xsl:text
																			...
																			<xsl:call-template name="ValuesBase">
																				<xsl:with-param
																					name="pRoot"
																					select="$AInfo/analytic:cadWorks/analytic:resultCadWorks/analytic:decisionToRefuse"
																				/>
																			</xsl:call-template>
																		</xsl:when>
																		<xsl:when
																			test="$AInfo/analytic:cadWorks/analytic:resultCadWorks/analytic:decisionErrorRegistry"
																		>
																			<xsl:text
																				>Количество решений о необходимости
																				устранения реестровых ошибок в сведениях
																				ЕГРН, связанных с ошибками, допущенными
																				кадастровыми инженерами при подготовке
																				межевых планов, технических планов,
																				актов обследования, карты-плана
																				территории
																			</xsl:text>
																			<xsl:call-template name="ValuesBase">
																				<xsl:with-param
																					name="pRoot"
																					select="$AInfo/analytic:cadWorks/analytic:resultCadWorks/analytic:decisionErrorRegistry"
																				/>
																			</xsl:call-template>
																		</xsl:when>
																	</xsl:choose>
		...
		<xsl:variable
			name="territoryType"
			select="$requestAInfo/analytic:territory"
		/>
										...
										<xsl:choose>
											...
											<xsl:when test="$territoryType/analytic:region">
												...
												<xsl:call-template name="regionCodeTemplate">
													<xsl:with-param
														name="regionCode"
														select="$territoryType/analytic:region"
													/>
												</xsl:call-template>
											</xsl:when>
											<xsl:when test="$territoryType/analytic:city">
												...
												<xsl:call-template name="createAddressTemplate">
													<xsl:with-param
														name="pathToAddress"
														select="$territoryType/analytic:city"
													/>
												</xsl:call-template>
											</xsl:when>
											<xsl:when test="$territoryType/analytic:locality">
												...
												<xsl:call-template name="createAddressTemplate">
													<xsl:with-param
														name="pathToAddress"
														select="$territoryType/analytic:locality"
													/>
												</xsl:call-template>
											</xsl:when>
											<xsl:when test="$territoryType/analytic:cadastralRegion">
												...
												<xsl:value-of
													select="$territoryType/analytic:cadastralRegion"
												/>
											</xsl:when>
											<xsl:when
												test="$territoryType/analytic:cadastralDistricts"
											>
												<xsl:text>кадастрового района </xsl:text>
												<xsl:for-each
													select="$territoryType/analytic:cadastralDistricts/analytic:cadastralDistrict"
												>
													<xsl:value-of select="." />
													<xsl:if test="position() != last()">
														<xsl:text>, </xsl:text>
											...
											<xsl:when test="$territoryType/analytic:cadastralBlocks">
												...
												<xsl:for-each
													select="$territoryType/analytic:cadastralBlocks/analytic:cadastralBlock"
												>
													<xsl:value-of select="." />
													<xsl:if test="position() != last()">
														<xsl:text>, </xsl:text>
						...
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad">
									...
									<xsl:choose>
										<xsl:when
											test="$periodType/analytic:period = '012003004000' "
										>
										...
										<xsl:when
											test="$periodType/analytic:period = '012003007000' "
										>
										...
										<xsl:when
											test="$periodType/analytic:period = '012003008000' "
										>
				...
				<div class="row">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad">
									Форма предоставления аналитической информации:
								</div>
							</div>
				...
				<div class="row">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad wrap">
									Способ получения аналитической информации:
								</div>
							</div>
							<div class="row">
								<div class="table tablemargin">
	...
	<xsl:template name="point32organization">
		...
		>
			<br />
			<xsl:text
				>страна регистрации (инкорпорации), код иностранной организации (КИО)
			</xsl:text>
			<span class="bold">
						...
						<div class="table tablemargin">
							<div class="row">
								<div class="table tablemargin">
									<div class="cell leftpad wrap">
										<xsl:text
											>Сведения о заявителе (физическом лице, арбитражном
											управляющем, нотариусе, судебном
						...
						<div class="row">
							<div class="table tablemargin">
								<div class="cell left wrap">
									...
									<br />
									<xsl:text
										>&nbsp;&nbsp;&nbsp;&nbsp; сведения, включенные в запрос,
										относящиеся к моей личности, а также внесенные мною ниже,
										достоверны;</xsl:text
									>
									<br />
									<xsl:text
										>&nbsp;&nbsp;&nbsp;&nbsp; документы (копии документов),
										приложенные к запросу, соответствуют требованиям,
										установленным законодательством Российской Федерации, на
										момент представления запроса эти документы действительны и
										содержат достоверные сведения.</xsl:text
									>
					...
					<div class="table tablemargin">
						<div class="row">
							<div class="table tablemargin">
								<div class="cell leftpad wrap">
									<xsl:text
										>Отметка принявшего запрос специалиста (или заполняется
										автоматически при представлении запроса)
									</xsl:text>
									<span class="bold">
										<xsl:value-of
	...
	<xsl:template name="regionCodeTemplate">
		...
		<xsl:if test="$regionCode = 99"
			>Иные территории, включая город и космодром Байконур</xsl:if
		>
	</xsl:template>
...
<xsl:value-of select="($thisDocument/doc:series)"/-->
	...
	<xsl:template name="agreementData">
		...
		<xsl:value-of
			select="$agreement//xs:simpleType[@name=$typeName]/xs:restriction/xs:enumeration[@value=$agreementCode]/xs:annotation/xs:documentation"
		/>
	</xsl:template>
	...
	<xsl:template name="utilizationTemplate">
		...
		<xsl:value-of
			select="$utilTypeEnum//xs:enumeration[@value=$utilization]/xs:annotation/xs:documentation"
		/>
	</xsl:template>
