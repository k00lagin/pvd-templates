...
>
	...
	<xsl:variable
		name="header"
		select="//tns:statementFormChangeRegisteredStatement/tns:header"
	/>
	<xsl:variable
		name="objects"
		select="//tns:statementFormChangeRegisteredStatement/tns:objects"
	/>
	<xsl:variable
		name="statementDetails"
		select="//tns:statementFormChangeRegisteredStatement/tns:statementDetails"
	/>
	...
	<xsl:variable
		name="operson"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:person"
	/>
	<xsl:variable
		name="opersonPrevileg"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:previligedPerson"
	/>
	<xsl:variable
		name="oorganization"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:organization"
	/>
	<xsl:variable
		name="ocountry"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:country"
	/>
	<xsl:variable
		name="orfSubject"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:rfSubject"
	/>
	<xsl:variable
		name="oother"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:other"
	/>
	<xsl:variable
		name="ocontractor"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:contractor"
	/>
	<!-- Представители 1го уровня-->
	<xsl:variable
		name="orperson"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:person"
	/>
	<xsl:variable
		name="orpersonPrevileg"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:previligedPerson"
	/>
	<xsl:variable
		name="ororganization"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:organization"
	/>
	<xsl:variable
		name="orcountry"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:country"
	/>
	<xsl:variable
		name="orrfSubject"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:rfSubject"
	/>
	<xsl:variable
		name="orother"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:other"
	/>
	<xsl:variable
		name="orcontractor"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:contractor"
	/>
	<!-- Представитель 2го уровня. (Предс-ль правообладателя - ЮЛ1 и представитель этого ЮЛ1 - ФЛ)-->
	<xsl:variable
		name="ororganizationPer"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:representative/subj:subject/subj:person"
	/>
	<xsl:variable
		name="ororganizationPerPrevileg"
		select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner/subj:representative/subj:subject/subj:representative/subj:subject/subj:previligedPerson"
	/>
	...
	<xsl:variable
		name="tempRepresent"
		select="(//tns:statementFormChangeRegisteredStatement/tns:subjects/descendant::subj:representative/subj:subject)"
	/>
	<xsl:variable
		name="tempRepFiltred"
	...
	<xsl:variable
		name="appDocs"
		select="//tns:statementFormChangeRegisteredStatement/tns:header/stCom:appliedDocument"
	/>
	...
	<xsl:variable
		name="nameOrganInner"
		select="tns:statementFormChangeRegisteredStatement/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:regRightAuthority"
	/>
...
input[type="reset"],input[type="submit"] {
						...
						<div class="table tablemargin">
							...
							<div class="row">
								<div class="cell leftpad wrap">
									документы на государственный кадастровый учет и (или)
									государственную регистрацию права которого были представлены
									ранее:
								</div>
							</div>
							<div class="row">
								<div class="table tablemargin">
									<div class="cell center wrap w280">
										<xsl:text
											>дата представления заявления и документов</xsl:text
										>
									</div>
									<div class="cell wrap center">
										<xsl:text
											>номер книги учета входящих документов, в которой
											документы были зарегистрированы, и номер записи в этой
											книге, под которым были зарегистрированы заявление и
											документы</xsl:text
										>
									</div>
								</div>
								...
								<div class="table tablemargin">
									<div class="cell center wrap w280 bold">
										<xsl:call-template name="DateStr">
											<xsl:with-param
												name="dateStr"
												select="$statementDetails/tns:changeRegisteredStatementAction/tns:statementRegDate"
											/>
										</xsl:call-template>
									</div>
									<div class="cell wrap center bold">
										<xsl:value-of
											select="$statementDetails/tns:changeRegisteredStatementAction/tns:previousStatementKUVDNumber"
										/>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="cell clear">
								<div class="table tablemargin">
									...
									<xsl:if
										test="$statementDetails/tns:changeRegisteredStatementAction/tns:time"
									>
										<div class="row">
											<div class="table tablemargin">
														...
														<div class="cell center wrap">
															<span class="center bottomborder bold">
																<xsl:call-template name="DateStr">
																	<xsl:with-param
																		name="dateStr"
																		select="$statementDetails/tns:changeRegisteredStatementAction/tns:time"
																	/>
																</xsl:call-template>
															...
															<br />
															<xsl:text
																>(указать срок до шести месяцев)</xsl:text
															>
														</div>
													</div>
												</div>
									...
									<xsl:if
										test="$statementDetails/tns:changeRegisteredStatementAction/tns:cause"
									>
										<div class="row">
											<div class="table tablemargin">
												<div class="row">
														...
														<div class="row">
															<div class="cell center wrap">
																<span class="center bold">
																	<xsl:value-of
																		select="$statementDetails/tns:changeRegisteredStatementAction/tns:cause"
																	/>
																</span>
															</div>
														</div>
						...
						<div class="row">
							...
							<div class="cell clear">
								<div class="table tablemargin">
									<div class="row">
										<div class="cell leftpad wrap">
											прекратить осуществление государственного кадастрового
											учета и (или) государственной регистрации прав и вернуть
											ранее представленные для их проведения документы
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="cell clear">
								<div class="table tablemargin">
									<div class="row">
										<div class="cell leftpad wrap">
											принять дополнительные документы
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="cell clear">
								<div class="table tablemargin">
									<div class="row">
										<div class="cell leftpad wrap">
											возобновить ранее приостановленные по заявлению
							...
							<div class="table tablemargin">
								...
								<div class="cell leftpad wrap">
									<xsl:text
										...
										государственной власти, органе местного
	...
	<xsl:template name="point41person">
		...
		<xsl:variable
			name="subjDoc"
			select="//tns:statementFormChangeRegisteredStatement/tns:header/stCom:appliedDocument/node()[@_id=$thisPerson/subj:idDocumentRef/@documentID]"
		/>
		<div class="row">
			<div class="table tablemargin">
						...
						<div class="row">
							<div class="table tablemargin">
								<div class="row">
									...
									<xsl:choose>
										<xsl:when
											test="$orperson or $ororganization or $orcountry or $orrfSubject or $orother or $orpersonPrevileg or $ororganizationPer or $ororganizationPerPrevileg or $orcontractor"
										>
											<div class="cell leftpad wrap">
			...
			<div class="table">
				<div class="row">
					...
					<div class="table tablemargin">
						<div class="row">
							<div class="cell leftpad wrap">
								Сведения о представителе заявителя – физическом лице (в том
								числе нотариусе, судебном приставе-исполнителе, кадастровом
								инженере):
							</div>
						</div>
			...
			<div class="table">
				<div class="row">
					...
					<div class="table tablemargin">
						<div class="row">
							<div class="cell leftpad wrap">
								Сведения о представителе заявителя – юридическом лице (в том
								числе органе государственной власти, ином государственном
			...
			<div class="table">
				<div class="row">
					...
					<div class="table tablemargin">
						<div class="row">
							<div class="cell leftpad wrap">
								Сведения о представителе заявителя – иное описание:
							</div>
						</div>
	...
	<xsl:template name="point6">
		<xsl:variable
			name="receiveMethod"
			select="//tns:statementFormChangeRegisteredStatement/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:receivingMethodCode"
		/>
	...
	<xsl:template name="point7">
		<xsl:variable
			name="deliveryMethod"
			select="//tns:statementFormChangeRegisteredStatement/tns:deliveryDetails/stCom:resultDeliveryMethod"
		/>
	...
	<xsl:template name="point10">
		<xsl:variable
			name="note10"
			select="//tns:statementFormChangeRegisteredStatement/tns:statementDetails/tns:note"
		/>
		<xsl:if test="$note10">
			<div class="table">
				<div class="row">
	...
	<xsl:template name="point13">
		<xsl:variable
			name="phoneNumber"
			select="//tns:statementFormChangeRegisteredStatement/tns:statementAgreements/stCom:qualityOfServiceTelephoneNumber"
		/>
		<div class="table">
			<div class="row">
	...
	<xsl:template name="point14">
		...
		<xsl:variable name="ownerIdList">
			<xsl:for-each
				select="//tns:statementFormChangeRegisteredStatement/tns:subjects/tns:owners/tns:owner"
			>
				<xsl:if test="subj:person | subj:previligedPerson">
	...
	<xsl:template name="point16">
		<xsl:variable
			name="note16"
			select="//tns:statementFormChangeRegisteredStatement/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:specialistNote"
		/>
		<xsl:if test="$note16">
			<div class="table">
				<div class="row">
