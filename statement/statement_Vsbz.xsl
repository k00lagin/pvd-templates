...
xmlns:adr="http://rosreestr.ru/services/v0.26/commons/Address">
	...
	<!-- Основные переменные -->
	<xsl:variable name="header" select="//tns:statementFormAppliedDocuments/tns:header"/>
	<!-- Заявители -->
	<xsl:variable name="operson" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:person"/>
	<xsl:variable name="opersonPrevileg" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:previligedPerson"/>
	<xsl:variable name="oorganization" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:organization"/>
	<xsl:variable name="ocountry" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:country"/>
	<xsl:variable name="orfSubject" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:rfSubject"/>
	<xsl:variable name="oother" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:other"/>
	<!-- Представители 1го уровня -->
	<xsl:variable name="orperson" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:person"/>
	<xsl:variable name="orpersonPrevileg" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:previligedPerson"/>
	<xsl:variable name="ororganization" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:organization"/>
	<xsl:variable name="orcountry" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:country"/>
	<xsl:variable name="orrfSubject" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:rfSubject"/>
	<xsl:variable name="orother" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:other"/>
	<!-- Представитель 2го уровня. (Предс-ль правообладателя  - ЮЛ1 и представитель этого ЮЛ1 - ФЛ)-->
	<xsl:variable name="ororganizationPer" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:representative/subj:subject/subj:person"/>
	<xsl:variable name="ororganizationPerPrevileg" select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:representative/subj:subject/subj:previligedPerson"/>
	...
	<xsl:variable name="tempRepresent" select="(//tns:statementFormAppliedDocuments/tns:subjects/descendant::subj:representative/subj:subject)"/>
	...
	<xsl:variable name="urd" select="//tns:statementFormAppliedDocuments/tns:header/stCom:actionCode"/>
	<xsl:variable name="nameOrganInner" select="tns:statementFormAppliedDocuments/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:regRightAuthority"/>

	<!-- Правообладатели -->
	<xsl:variable name="owners" select="//tns:statementFormAppliedDocuments/tns:statementDetails/tns:owner"/>
	...
	<xsl:variable name="point4Codes" select="'-659411111133-659411111135-659411111136'"/>
...
input[type="reset"],input[type="submit"]{-webkit-appearance:button;cursor:pointer}button[disabled],html input[disabled]{cursor:default}button::-moz-focus-inner,input::-moz-focus-inner{border:0;padding:0}input{line-height:normal}input[type="checkbox"],input[type="radio"]{box-sizing:border-box;padding:0}input[type="number"]::-webkit-inner-spin-button,input[type="number"]::-webkit-outer-spin-button{height:auto}input[type="search"]{-webkit-appearance:textfield;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;box-sizing:content-box}input[type="search"]::-webkit-search-cancel-button,input[type="search"]::-webkit-search-decoration{-webkit-appearance:none}fieldset{border:1px solid silver;margin:0 2px;padding:.35em .625em .75em}legend{border:0;padding:0}textarea{overflow:auto}optgroup{font-weight:700}table{border-collapse:collapse;border-spacing:0}td,th{padding:0}
						...
						<div class="row">
							...
							<xsl:if test="$oorganization | $ocountry | $orfSubject | $oother | $ororganization | $orcountry | $orrfSubject | $orother">
								...
								<xsl:variable name="declarantIdList"> 
									  <xsl:for-each select="//tns:statementFormAppliedDocuments/tns:subjects/tns:declarant"> 
	...
	<xsl:template name="point711">
		...
		<xsl:variable name="subjDoc" select="//tns:statementFormAppliedDocuments/tns:header/stCom:appliedDocument/node()[@_id=$curPerson/subj:idDocumentRef/@documentID]"/>
		<div class="table tablemargin">
			<div class="row">
	...
	<xsl:template name="point71person">
		...
		<xsl:variable name="subjDoc" select="//tns:statementFormAppliedDocuments/tns:header/stCom:appliedDocument/node()[@_id=$thisPerson/subj:idDocumentRef/@documentID]"/>
		<div class="row">
			<div class="table tablemargin">
		...
		<div class="row">
			<div class="table tablemargin">
				...
				<div class="cell leftpad wrap bold">
					...
					<xsl:if test="$thisOrganization/subj:name | $thisOrganization/subj:Name">
						<xsl:value-of select="$thisOrganization/subj:name | $thisOrganization/subj:Name"/>
					</xsl:if>		
	...
	<xsl:template name="point2">
		<xsl:variable name="appDocs" select="//tns:statementFormAppliedDocuments/tns:header/stCom:appliedDocument"/>
		<xsl:if test="$appDocs">
	...
	<xsl:template name="point3">
		<xsl:variable name="prevKUVD" select="//tns:statementFormAppliedDocuments/tns:statementDetails/tns:appliedDocumentsAction/tns:previousStatementKUVDNumber"/>
								...
								<div class="row">
									<div class="table tablemargin">
										<div class="cell leftpad wrap">
											...
											<xsl:text>Регистрационный номер заявления, по которому ранее было принято решение об отказе в государственном кадастровом учете и (или) государственной регистрации прав: </xsl:text>
						...
						<div class="cell clear">
							<div class="table tablemargin">
								<div class="row">
									<div class="table tablemargin">
										<div class="cell leftpad wrap">
											<xsl:text>Застройщик, у которого отсутствуют права привлекать денежные средства граждан, являющихся участниками долевого строительства:</xsl:text>
										</div>
									</div>
								</div>
