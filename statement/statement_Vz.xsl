...
xmlns:adr="http://rosreestr.ru/services/v0.26/commons/Address">
	<!--Версия: 0.12-->
	<!--01.10.2016 Заявление о выдаче закладной-->
	<!--Версия: 0.13-->
	<!--12.12.2016-->
	...
	<xsl:variable name="mortgageAction" select="//tns:statementFormMortgage/tns:statementDetails/tns:mortgageAction"/>
	<xsl:variable name="registryChangeAction" select="//tns:statementFormMortgage/tns:statementDetails/tns:mortgageAction/tns:registryChangeAction"/>
	<xsl:variable name="mortgageBondIssueAction" select="//tns:statementFormMortgage/tns:statementDetails/tns:mortgageAction/tns:mortgageBondIssueAction"/>
	<!-- Земельный участок -->
	...
	<!-- Заявители -->
	<xsl:variable name="operson" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:person"/>
	<xsl:variable name="opersonPrevileg" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:previligedPerson"/>
	<xsl:variable name="oorganization" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:organization"/>
	<xsl:variable name="ocountry" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:country"/>
	<xsl:variable name="orfSubject" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:rfSubject"/>
	<xsl:variable name="oother" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:other"/>
	<!-- Представители 1го уровня -->
	<xsl:variable name="orperson" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:person"/>
	<xsl:variable name="orpersonPrevileg" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:previligedPerson"/>
	<xsl:variable name="ororganization" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:organization"/>
	<xsl:variable name="orcountry" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:country"/>
	<xsl:variable name="orrfSubject" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:rfSubject"/>
	<xsl:variable name="orother" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:other"/>
	<!-- Представитель 2го уровня. (Предс-ль правообладателя  - ЮЛ1 и представитель этого ЮЛ1 - ФЛ)-->
	<xsl:variable name="ororganizationPer" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:representative/subj:subject/subj:person"/>
	<xsl:variable name="ororganizationPerPrevileg" select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:representative/subj:subject/subj:previligedPerson"/>
	...
	<xsl:variable name="tempRepresent" select="(//tns:statementFormMortgage/tns:subjects/descendant::subj:representative/subj:subject)"/>
	<xsl:variable name="tempRepFiltred" select="$tempRepresent/self::node()[not(@_id=preceding::subj:subject/@_id)]"/>
	<!-- Разное -->
	<xsl:variable name="appDocs" select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument"/>
	...
	<!-- Блок для подсчета страниц, документов и копий -->
		...
		<xsl:variable name="nameOrganInner" select="tns:statementFormMortgage/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:regRightAuthority"/>
	...
	<xsl:template match="tns:statementFormMortgage">
		<html lang="ru">
			<head>
...
input[type="reset"],input[type="submit"]{-webkit-appearance:button;cursor:pointer}button[disabled],html input[disabled]{cursor:default}button::-moz-focus-inner,input::-moz-focus-inner{border:0;padding:0}input{line-height:normal}input[type="checkbox"],input[type="radio"]{box-sizing:border-box;padding:0}input[type="number"]::-webkit-inner-spin-button,input[type="number"]::-webkit-outer-spin-button{height:auto}input[type="search"]{-webkit-appearance:textfield;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;box-sizing:content-box}input[type="search"]::-webkit-search-cancel-button,input[type="search"]::-webkit-search-decoration{-webkit-appearance:none}fieldset{border:1px solid silver;margin:0 2px;padding:.35em .625em .75em}legend{border:0;padding:0}textarea{overflow:auto}optgroup{font-weight:700}table{border-collapse:collapse;border-spacing:0}td,th{padding:0}
	...
	<xsl:template name="point3_1">
		<xsl:if test="//tns:statementFormMortgage/tns:objects/stCom:object">
			<div class="table">
				<div class="row">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							...
							<xsl:for-each select="//tns:statementFormMortgage/tns:objects/stCom:object">
	...
	<xsl:template name="point3_2">
		<xsl:if test="$mortgageBondIssueAction">
			<div class="row">
				<div class="table tablemargin">
					...
					<div class="table tablemargin">
						<div class="row">
							...
							<div class="cell clear">
								<div class="table tablemargin">
									<div class="row">
										<div class="cell leftpad wrap">выдать закладную в связи с ипотекой, зарегистрированной в Едином государственном реестре недвижимости</div>
									</div>
									<div class="table tablemargin">
										<div class="row">
											<div class="cell center wrap w331">
												<xsl:text>дата регистрации ипотеки:</xsl:text>
											</div>
											<div class="cell center wrap">
												<xsl:text>номер регистрации ипотеки:</xsl:text>
											</div>
										</div>
										<div class="row">
											<div class="cell center w331 bold">
												<xsl:call-template name="DateStr">
													<xsl:with-param name="dateStr" select="$mortgageBondIssueAction/tns:mortgageRegDate"/>
												</xsl:call-template>
											</div>
											<div class="cell center wrap bold">
												<xsl:value-of select="$mortgageBondIssueAction/tns:mortgageRegNumber"/>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="table tablemargin">
								<div class="cell leftpad wrap">
									<xsl:text>Залогодержатель (законный владелец закладной):</xsl:text>
								</div>
							</div>
						</div>
						<xsl:if test="$oorganization | $ocountry | $orfSubject | $oother">
							<xsl:call-template name="point412"/>
						</xsl:if>
						<xsl:if test="$operson | $opersonPrevileg">
							<xsl:call-template name="point411">
	...
	<!--Раздел 4.1.1-->
	<xsl:template name="point411">
		<xsl:param name="curPerson"/>
		<xsl:variable name="subjDoc" select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument/node()[@_id=$curPerson/subj:idDocumentRef/@documentID]"/>
		<div class="table tablemargin">
			<div class="row">
				<div class="cell center w40 bold">V</div>
				<div class="cell clear">
					<div class="table tablemargin">
						<div class="row">
							<div class="table tablemargin">
								<div class="cell leftpad wrap">
									<xsl:text>физические лицо:</xsl:text>
								</div>
							</div>
						</div>
						...
						<!--xsl:if test="$curPerson/parent::node()/following-sibling::node()">
							<xsl:for-each select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument/node()[@_id=$curPerson/parent::node()/following-sibling::node()/@documentID]">
								<xsl:call-template name="documentTemplate">
									<xsl:with-param name="thisDocument" select="."/>
								</xsl:call-template>
							</xsl:for-each>
			...
			<div class="row">
				...
				<div class="cell clear">
					<div class="table tablemargin">
						...
						<!-- debug xsl:value-of select="$tmpDocNode/parent::node()/following-sibling::node()/doc:document"/-->
						<!--xsl:if test="$tmpDocNode/parent::node()/following-sibling::node()">
							<xsl:for-each select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument/node()[@_id=$tmpDocNode/parent::node()/following-sibling::node()/@documentID]">
								<xsl:call-template name="documentTemplate">
									<xsl:with-param name="thisDocument" select="."/>
								</xsl:call-template>
							</xsl:for-each>
	...
	<xsl:template name="point41person">
		...
		<xsl:variable name="subjDoc" select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument/node()[@_id=$thisPerson/subj:idDocumentRef/@documentID]"/>
		<div class="row">
			<div class="table tablemargin">
	...
	<xsl:template name="point5">
		<xsl:variable name="receiveMethod" select="//tns:statementFormMortgage/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:receivingMethodCode"/>
			...
			<div class="table">
				<div class="row">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad wrap">Способ представления заявления и иных необходимых документов:</div>
							</div>
							<xsl:if test="$receiveMethod = 'regRightAuthority' or $receiveMethod = 'mfc' or $receiveMethod = 'extReceipt'">
								<div class="row">
									<div class="table tablemargin">
										...
										<div class="cell center w40 wrap bold">V</div>
										<div class="cell leftpad wrap">
	...
	<xsl:template name="point6">
		<xsl:variable name="deliveryMethod" select="//tns:statementFormMortgage/tns:deliveryDetails/stCom:resultDeliveryMethod"/>
				...
				<div class="row">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad wrap">
									<xsl:text>Способ получения документов</xsl:text>
									<xsl:text> (в том числе уведомления о приостановлении, сообщения об отказе):</xsl:text>
								</div>
							</div>
		...
		<div class="table">
			<div class="row">
				...
				<div class="cell clear">
					<div class="table tablemargin">
						<div class="row">
							<div class="cell leftpad">Заявитель:</div>
						</div>
						<div class="row">
							<div class="table tablemargin">
								<div class="row">
									...
									<div class="cell clear">
										<div class="table tablemargin">
											<div class="row">
												<xsl:choose>
													<xsl:when test="normalize-space($tempRepFiltred)">
														<div class="cell leftpad wrap">
															<xsl:text>Представитель залогодержателя:</xsl:text>
														</div>
													</xsl:when>
													<xsl:otherwise>
														<div class="cell leftpad wrap">
															<xsl:text>Залогодержатель лично</xsl:text>
														</div>
													</xsl:otherwise>
												</xsl:choose>
											</div>	
											<xsl:if test="normalize-space($repPersonList)">
												<xsl:call-template name="point8_1">
											...
											<xsl:if test="normalize-space($repOrgList)">
												<xsl:call-template name="point8_2">
	...
	<xsl:template name="point8_1">
		<xsl:param name="curPerson"/>
		<!--Старое форматирование. Оставим, может пригодится, но придется добавлять параметр в вызов "point41person" т.к. уезжает правый столбец-->
		<!--div class="table">
			<div class="row">
				<div class="cell leftpad w40 bold">V</div>
					<div class="table tablemargin">
						<div class="row">
							<xsl:choose>
								<xsl:when test="$rvzpiopActionCode = $repRvz">
									<div class="cell leftpad wrap bold">физическое лицо (в том числе нотариус):</div>
								</xsl:when>
								<xsl:when test="$rvzpiopActionCode = $repPi">
									<div class="cell leftpad wrap bold">физическое лицо:</div>
								</xsl:when>
								<xsl:when test="$rvzpiopActionCode = $repOp">
									<div class="cell leftpad wrap bold">физическое лицо:</div>
								</xsl:when>
								<xsl:otherwise>
									<div class="cell leftpad wrap bold">физическое лицо:</div>
						...
						<xsl:if test="$orperson or $orpersonPrevileg or $ororganizationPer or $ororganizationPerPrevileg">
							<xsl:call-template name="point811">
								<xsl:with-param name="curPerson" select="$orperson | $orpersonPrevileg | $ororganizationPer | $ororganizationPerPrevileg"/>
							</xsl:call-template>
						</xsl:if>
					</div>
			</div>	
		...
		<div class="table tablemargin">
			<div class="row">
				<div class="cell center w40 bold">V</div>
				<div class="cell leftpad wrap">
					<xsl:text>физическое лицо (в том числе нотариус):</xsl:text>
				</div>
			</div>
		</div>
		<xsl:call-template name="point811">
			<xsl:with-param name="curPerson" select="$curPerson"/>
		</xsl:call-template>
	</xsl:template>
	<xsl:template name="point8_2">
		<xsl:param name="curPerson"/>
		<!--Старое форматирование. Оставим, может пригодится, но _возможно_ придется добавлять параметр в вызов "point42organization" т.к. может уехать форматирование-->
		<!--div class="table">
			<div class="row">
				<div class="cell leftpad w40 bold">V</div>
					<div class="table tablemargin">
						<div class="row">
							<xsl:choose>
								<xsl:when test="$rvzpiopActionCode = $repRvz">
									<div class="cell leftpad wrap bold">юридическое лицо, в том числе орган государственной власти, иной государственный орган, орган местного самоуправления:</div>
								</xsl:when>
								<xsl:when test="$rvzpiopActionCode = $repPi">
									<div class="cell leftpad wrap bold">юридическое лицо:</div>
								</xsl:when>
								<xsl:when test="$rvzpiopActionCode = $repOp">
									<div class="cell leftpad wrap bold">юридическое лицо:</div>
								</xsl:when>
		...
		<div class="table tablemargin">
			<div class="row">
				<div class="cell center w40 bold">V</div>
				<div class="cell leftpad wrap">
					<xsl:text>юридическое лицо, в том числе орган государственной власти, иной государственный орган, орган местного самоуправления:</xsl:text>
				</div>
			</div>
		</div>
		<xsl:call-template name="point812">
	...
	<xsl:template name="point812">
		...
		<!-- перенесено внутрь цикла выше xsl:variable name="tmpDocNode" select="$ororganization | $orcountry | $orrfSubject | $orother"/>
		<xsl:if test="$tmpDocNode/parent::node()/following-sibling::node()">
			<xsl:for-each select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument/node()[@_id=$tmpDocNode/parent::node()/following-sibling::node()/@documentID]">
				<xsl:call-template name="documentTemplate">
					<xsl:with-param name="thisDocument" select="."/>
		...
		<xsl:if test="not(($needAppDocs = 'regRightAuthority') or ($needAppDocs = 'mfc') or ($needAppDocs = 'extReceipt')) ">
			...
			<xsl:if test="$appDocs">
				...
				<xsl:if test="$totalCheck &lt; $appDocCount">
					<div class="table">
						<div class="row">
							<div class="cell leftpad w40">9</div>
							<div class="cell clear">
								<div class="table tablemargin">
									<div class="row">
										<div class="table tablemargin">
	...
	<xsl:template name="point10">
		<xsl:variable name="note10" select="//tns:statementFormMortgage/tns:statementDetails/tns:note"/>
		<xsl:if test="$note10">
			<div class="table">
				<div class="row">
	...
	<xsl:template name="point15">
		<xsl:variable name="note15" select="//tns:statementFormMortgage/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:specialistNote"/>
		<xsl:if test="$note15">
			<div class="table">
				<div class="row">
					<div class="cell leftpad w40">15</div>
					<div class="cell clear">
						<div class="table tablemargin">
							<div class="row">
								<div class="table tablemargin">
	...
	<xsl:template name="rightRestrictionsKindTemplate">
		...
		<xsl:value-of select="$rightRestrictionsKindEnum//xs:enumeration[@value=$rightRestrictionsKind]/xs:annotation/xs:documentation"/>
	</xsl:template>
