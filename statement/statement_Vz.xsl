...
>
	...
	<xsl:variable
		name="mortgageAction"
		select="//tns:statementFormMortgage/tns:statementDetails/tns:mortgageAction"
	/>
	<xsl:variable
		name="registryChangeAction"
		select="//tns:statementFormMortgage/tns:statementDetails/tns:mortgageAction/tns:registryChangeAction"
	/>
	<xsl:variable
		name="mortgageBondIssueAction"
		select="//tns:statementFormMortgage/tns:statementDetails/tns:mortgageAction/tns:mortgageBondIssueAction"
	/>
	<!-- Земельный участок -->
	...
	<xsl:variable
		name="operson"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:person"
	/>
	<xsl:variable
		name="opersonPrevileg"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:previligedPerson"
	/>
	<xsl:variable
		name="oorganization"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:organization"
	/>
	<xsl:variable
		name="ocountry"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:country"
	/>
	<xsl:variable
		name="orfSubject"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:rfSubject"
	/>
	<xsl:variable
		name="oother"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:other"
	/>
	<!-- Представители 1го уровня -->
	<xsl:variable
		name="orperson"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:person"
	/>
	<xsl:variable
		name="orpersonPrevileg"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:previligedPerson"
	/>
	<xsl:variable
		name="ororganization"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:organization"
	/>
	<xsl:variable
		name="orcountry"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:country"
	/>
	<xsl:variable
		name="orrfSubject"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:rfSubject"
	/>
	<xsl:variable
		name="orother"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:other"
	/>
	<!-- Представитель 2го уровня. (Предс-ль правообладателя - ЮЛ1 и представитель этого ЮЛ1 - ФЛ)-->
	<xsl:variable
		name="ororganizationPer"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:representative/subj:subject/subj:person"
	/>
	<xsl:variable
		name="ororganizationPerPrevileg"
		select="//tns:statementFormMortgage/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:representative/subj:subject/subj:previligedPerson"
	/>
	...
	<xsl:variable
		name="tempRepresent"
		select="(//tns:statementFormMortgage/tns:subjects/descendant::subj:representative/subj:subject)"
	/>
	<xsl:variable
		name="tempRepFiltred"
	...
	<xsl:variable
		name="appDocs"
		select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument"
	/>
	...
	<xsl:variable
		name="nameOrganInner"
		select="tns:statementFormMortgage/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:regRightAuthority"
	/>
...
input[type="reset"],input[type="submit"] {
				...
				<div class="row">
					...
					<div class="cell clear">
						<div class="table tablemargin">
							...
							<xsl:for-each
								select="//tns:statementFormMortgage/tns:objects/stCom:object"
							>
								...
								<div class="table tablemargin">
									<div class="row">
										<div class="cell leftpad wrap">
											выдать закладную в связи с ипотекой, зарегистрированной в
										...
										<div class="row">
											<div class="cell center w331 bold">
												<xsl:call-template name="DateStr">
													<xsl:with-param
														name="dateStr"
														select="$mortgageBondIssueAction/tns:mortgageRegDate"
													/>
												</xsl:call-template>
											</div>
											<div class="cell center wrap bold">
												<xsl:value-of
													select="$mortgageBondIssueAction/tns:mortgageRegNumber"
												/>
											</div>
										</div>
									</div>
					...
					<div class="table tablemargin">
						<div class="row">
							<div class="table tablemargin">
								<div class="cell leftpad wrap">
									<xsl:text
										>Залогодержатель (законный владелец закладной):</xsl:text
									>
								</div>
							</div>
						</div>
	...
	<xsl:template name="point411">
		...
		<xsl:variable
			name="subjDoc"
			select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument/node()[@_id=$curPerson/subj:idDocumentRef/@documentID]"
		/>
		<div class="table tablemargin">
			<div class="row">
				<div class="cell center w40 bold">V</div>
	...
	<xsl:template name="point41person">
		...
		<xsl:variable
			name="subjDoc"
			select="//tns:statementFormMortgage/tns:header/stCom:appliedDocument/node()[@_id=$thisPerson/subj:idDocumentRef/@documentID]"
		/>
		<div class="row">
			<div class="table tablemargin">
	...
	<xsl:template name="point5">
		<xsl:variable
			name="receiveMethod"
			select="//tns:statementFormMortgage/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:receivingMethodCode"
		/>
	...
	<xsl:template name="point6">
		<xsl:variable
			name="deliveryMethod"
			select="//tns:statementFormMortgage/tns:deliveryDetails/stCom:resultDeliveryMethod"
		/>
						...
						<div class="table tablemargin">
							<div class="row">
								<div class="cell leftpad wrap">
									...
									<xsl:text>
										(в том числе уведомления о приостановлении, сообщения об
										отказе):</xsl:text
									>
								</div>
							</div>
					...
					<div class="row">
						...
						<div class="cell clear">
							<div class="table tablemargin">
								...
								<xsl:if
									test="$deliveryMethod/stCom:doNotSendRecieveNotification"
								>
									<div class="row">
										<div class="table tablemargin">
											<div class="cell center w40 bold">V</div>
											<div class="cell leftpad wrap">
												<xsl:text
													>не направлять уведомление о приеме данного заявления
													и прилагаемых к нему документов</xsl:text
												>
											</div>
										</div>
									</div>
											...
											<div class="row">
												<xsl:choose>
													<xsl:when test="normalize-space($tempRepFiltred)">
														<div class="cell leftpad wrap">
															<xsl:text
																>Представитель залогодержателя:</xsl:text
															>
														</div>
													</xsl:when>
													<xsl:otherwise>
	...
	<xsl:template name="point8_2">
		...
		<div class="table tablemargin">
			<div class="row">
				...
				<div class="cell leftpad wrap">
					<xsl:text
						>юридическое лицо, в том числе орган государственной власти, иной
						государственный орган, орган местного самоуправления:</xsl:text
					>
				</div>
			</div>
		</div>
	...
	<xsl:template name="point10">
		<xsl:variable
			name="note10"
			select="//tns:statementFormMortgage/tns:statementDetails/tns:note"
		/>
		<xsl:if test="$note10">
			<div class="table">
				<div class="row">
				...
				<div class="table tablemargin">
					<div class="cell leftpad wrap">
						<xsl:text
							...
							также иных действий, необходимых для обработки персональных данных
							в рамках предоставления органами регистрации прав в соответствии с
							законодательством Российской Федерации государственных услуг), в
							том числе в автоматизированном режиме, включая принятие решений на
							их основе органом регистрации прав, в целях предоставления
	...
	<xsl:template name="point15">
		<xsl:variable
			name="note15"
			select="//tns:statementFormMortgage/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:specialistNote"
		/>
		<xsl:if test="$note15">
			<div class="table">
				<div class="row">
