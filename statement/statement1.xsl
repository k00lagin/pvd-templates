...
<!--Версия: 0.1-->
	...
	<xsl:variable name="cntDocs" select="count(descendant::tns:header/stCom:appliedDocument)"/>
	<xsl:variable name="cadastralActions" select="//tns:statementForm1/tns:statementDetails/tns:cadastralActions"/>
	<xsl:variable name="rightsAction3" select="//tns:statementForm1/tns:statementDetails/tns:rightsAction"/>
	<xsl:variable name="combinedAction3" select="//tns:statementForm1/tns:statementDetails/tns:combinedAction"/>
	<xsl:variable name="cadastralActionsCombined" select="//tns:statementForm1/tns:statementDetails/tns:combinedAction/tns:cadastralActions"/>
	<xsl:variable name="rightActionType" select="//tns:statementForm1/tns:statementDetails/tns:rightsAction/tns:rightActionType"/>
	<xsl:variable name="rightActionTypeCombined" select="//tns:statementForm1/tns:statementDetails/tns:combinedAction/tns:rightsAction/tns:rightActionType"/>
	<xsl:variable name="rightKind" select="//tns:statementForm1/tns:statementDetails/tns:rightsAction/tns:rightKind"/>
	<xsl:variable name="rightKindCombined" select="//tns:statementForm1/tns:statementDetails/tns:combinedAction/tns:rightsAction/tns:rightKind"/>
	<xsl:variable name="rightRestrictionsKind" select="//tns:statementForm1/tns:statementDetails/tns:rightsAction/tns:rightRestrictionsKind"/>
	<xsl:variable name="rightRestrictionsKindCombined" select="//tns:statementForm1/tns:statementDetails/tns:combinedAction/tns:rightsAction/tns:rightRestrictionsKind"/>
	<xsl:variable name="dealCode" select="//tns:statementForm1/tns:statementDetails/tns:rightsAction/tns:dealCode"/>
	<xsl:variable name="dealCodeCombined" select="//tns:statementForm1/tns:statementDetails/tns:combinedAction/tns:rightsAction/tns:dealCode"/>
	<xsl:variable name="sharePartAny" select="//tns:statementForm1/tns:statementDetails/descendant::tns:sharePart"/>
	<!-- Правообладатели-->
	<xsl:variable name="operson" select="//tns:statementForm1/tns:subjects/tns:owners/tns:owner/subj:person"/>
	<xsl:variable name="opersonPrevileg" select="//tns:statementForm1/tns:subjects/tns:owners/tns:owner/subj:previligedPerson"/>
	<xsl:variable name="oorganization" select="//tns:statementForm1/tns:subjects/tns:owners/tns:owner/subj:organization"/>
	<xsl:variable name="ocountry" select="//tns:statementForm1/tns:subjects/tns:owners/tns:owner/subj:country"/>
	<xsl:variable name="orfSubject" select="//tns:statementForm1/tns:subjects/tns:owners/tns:owner/subj:rfSubject"/>
	<xsl:variable name="oother" select="//tns:statementForm1/tns:subjects/tns:owners/tns:owner/subj:other"/>
	<xsl:variable name="ocontractor" select="//tns:statementForm1/tns:subjects/tns:owners/tns:owner/subj:contractor"/>
	...
	<xsl:variable name="tempRepresent" select="(//tns:statementForm1/tns:subjects/descendant::subj:representative/subj:subject)"/>
<!--	<xsl:variable name="tempRepFiltred" select="$tempRepresent/self::node()[not(@_id=preceding::subj:subject/@_id)]"/>-->
    <xsl:variable name="tempRepFiltred" select="$tempRepresent/self::node()[not(string(@_id)=preceding::subj:subject/@_id)]"/>

	<!-- Разное -->
	<xsl:variable name="appDocs" select="//tns:statementForm1/tns:header/stCom:appliedDocument"/>
	...
	<!-- Блок для подсчета страниц, документов и копий -->
		...
		<xsl:variable name="nameOrganInner" select="tns:statementForm1/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:regRightAuthority"/>
		...
		<html lang="ru">
			<head>
                ...
                <style type="text/css">
                    ...
                    .75em}legend{border:0;padding:0}textarea{overflow:auto}optgroup{font-weight:700}table{border-collapse:collapse;border-spacing:0}td,th{padding:0}
                </style>
                <style type="text/css">body{font-family:times new
                    roman,arial,sans-serif;font-size:100%;line-height:1.42857143;color:#000;background-color:#fff}#wrapper{width:800px;margin:0
                    auto;overflow:hidden;border:1px solid
                    #000;-webkit-hyphens:auto;-moz-hyphens:auto;-ms-hyphens:auto;hyphens:auto;word-break:break-word;margin-top:0px;margin-bottom:0px}#wrapper1{width:800px;margin:0
                    auto;overflow:hidden;border:1px solid
                    #000;-webkit-hyphens:auto;-moz-hyphens:auto;-ms-hyphens:auto;hyphens:auto;word-break:break-word;margin-top:0px;margin-bottom:0px}#wrapperClear{width:800px;overflow:hidden;-webkit-hyphens:auto;-moz-hyphens:auto;-ms-hyphens:auto;hyphens:auto;word-break:break-word;margin:10px
                    auto;margin-top:5px;margin-bottom:3px;}section{border-spacing:1px}.table{display:table;border:0;width:100%;white-space:nowrap;table-layout:fixed}.row{display:table-row}
                    .cell{content:'';overflow-wrap:break-word;word-wrap:break-word;-ms-word-break:break-all;word-break:break-all;word-break:break-word;-ms-hyphens:auto;-moz-hyphens:auto;-webkit-hyphens:auto;hyphens:auto;display:table-cell;border:1px
                    solid #000;padding:2px 8px}.cell-top{border-bottom:none}.cell-mid{border-top:none;border-bottom:none}.cell-bottom{border-top:none}.title{padding-left:0;padding-right:0}.title .ul{border-bottom:1px solid
                    #000}.supertitle{padding-left:8px;padding-right:8px;width:360px;font-size:80%}.supertitleabs{position:absolute;top:58px;padding-left:8px;padding-right:8px;height:50px;width:360px;line-height:3.1;font-size:80%}.superaddr{position:absolute;top:310px;padding-left:8px;padding-right:8px;width:727px;line-height:1.63}.book{display:inline-block;#vertical-align:top;#line-height:1.2;font-size:83%}.undertext{display:inline-block;vertical-align:top;line-height:1.4;font-size:64%;top:0}.bookmargin{margin-top:-8px}@media
                    screen and (min-width:0) and (min-resolution:
                    +72dpi){.tablemargin{margin-top:-1px;margin-bottom:-1px;margin-left:-1px;width:calc(100% +
                    2px)}}.marginleft{margin-left:-1px}.clear{border:0;padding:0}.borders{border:1px solid
                    #000}.noborder{border:0}.leftborder{border-left:1px solid #000}.topborder{border-top:1px solid
                    #000}.bottomborder{border-bottom:1px solid
                    #000}.nopadding{padding:0}.nospacing{border-spacing:0}.lh-normal{line-height:normal}.lh-middle{line-height:1.2}.lh-small{line-height:1}.leftpad{padding-left:8px}.bottompad{padding-bottom:10px}.bottompad5{padding-bottom:5px}.updownpad{padding-top:10px;padding-bottom:10px}.sidepad{padding-left:8px;padding-right:8px;padding-top:8px}.boxpad{padding-left:5px;padding-right:5px}.toppad5{padding-top:5px}.notoppad{padding-top:0}span.box{display:inline-block;width:25px;text-align:center}.wrap{white-space:normal;-webkit-hyphens:manual;-moz-hyphens:manual;-ms-hyphens:manual;hyphens:manual;word-break:normal}.block{display:block}.inline{display:inline}.inlineblock{display:inline-block}.float{float:left}.center{text-align:center}.justify{text-align:justify}.justifylast{text-align:justify;text-align-last:justify;-moz-text-align-last:justify;-webkit-text-align-last:justify}.justifyleft{text-align:justify;text-align-last:left;-moz-text-align-last:left;-webkit-text-align-last:left}.left{text-align:left}.right{text-align:right}.vmiddle{vertical-align:middle}.bold{font-weight:700}.normal{font-weight:400}.mtop2{margin-top:2px}.h1{height:1px\0/!important}.h60{height:60px}.h100{height:100%}.ht{height:calc(100%
                    +
                    2px)}.w5{width:5px}.w10{width:10px}.w15{width:15px}.w20{width:20px}.w30{width:30px}.w35{width:35px}.w40{width:40px}.w43{width:43px}.w45{width:45px}.w50{width:50px}.w55{width:55px}.w65{width:65px}.w75{width:75px}.w85{width:85px}.w90{width:90px}.w100{width:100px}.w115{width:115px}.w135{width:135px}.w140{width:140px}.w150{width:150px}.w152{width:152px}.w155{width:155px}.w160{width:160px}.w165{width:165px}.w182{width:182px}.w184{width:184px}.w185{width:185px}.w190{width:190px}.w200{width:200px}.w201{width:201px}.w217{width:217px}.w220{width:220px}.w234{width:234px}.w248{width:248px}.w251{width:251px}.w260{width:260px}.w270{width:270px}.w280{width:280px}.w290{width:290px}.w295{width:295px}.w300{width:300px}.w350{width:350px}.w360{width:360px}.w380{width:380px}.w385{width:385px}.w400{width:400px}.w430{width:430px}.w528{width:528px}.w542{width:542px}.w543{width:543px}.w545{width:545px}*,:before,:after{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}
                </style>
                <style type="text/css">
                    #header1 {
                ...
                <xsl:comment>
                    <![CDATA[[[if IE 8]><style type="text/css">.tablemargin{width:calc(100% + 2px)}</style><![endif]]]></xsl:comment>
                <xsl:comment>
                    <![CDATA[[if !(IE 8)|!(IE)]><style type="text/css">.tablemargin{margin-top:-1px;margin-bottom:-1px;margin-left:-1px;width:calc(100% + 2px)}</style><![endif]]]></xsl:comment>
                    ...
                    <div class="sidepad wrap">
                        ...
                        <div class="">
                            ...
                            <xsl:if test="not(normalize-space($when)) or not(normalize-space($numPPOZ))">
                                <span>2.6 дата &laquo;_____&raquo; ___________________ _______ г., время ______ ч.,
                                    ______ мин.
                                </span>
                            </xsl:if>
                        </div>
    ...
    <xsl:template name="point3">
        ...
        <xsl:if test="$combinedAction3 and //tns:statementForm1/tns:header/stCom:actionCode != '659311111117'">
            ...
            <div class="table">
                <div class="row">
                    ...
                    <div class="cell leftpad">
                        <xsl:text>государственный кадастровый учет и государственную регистрацию прав </xsl:text>
                    </div>
                </div>
            </div>
        </xsl:if>
        ...
        <xsl:if test="$rightsAction3 or //tns:statementForm1/tns:header/stCom:actionCode = '659311111117'">
            <div class="table">
                <div class="row">
    ...
    <xsl:template name="point5">
        ...
        <xsl:if test="$cadastralActions or ($combinedAction3 and //tns:statementForm1/tns:header/stCom:actionCode != '659311111117')">
            <div class="table">
                <div class="row">
                    ...
                    <div class="cell clear">
                        <div class="table tablemargin">
                            <div class="row">
                                <div class="cell leftpad">В части государственного кадастрового учета осуществить:</div>
                            </div>
                            ...
                            <xsl:for-each
                                ...
                                <xsl:variable name="currentActionType" select="@cadastralActionType"/>
                                ...
                                <xsl:if test="$currentActionType = '111200003010' or $currentActionType = '111200003020' or $currentActionType = '111200003030' or $currentActionType = '111200003040' or $currentActionType = '111200003050' or $currentActionType = '111200003060'">
                                    <div class="row">
                                        <div class="table tablemargin">
                                            <div class="cell center w40 bold">V</div>
                                            <div class="cell leftpad">
                                    ...
                                    <div class="row">
                                        <div class="table tablemargin">
                                            ...
                                            <div class="cell leftpad wrap">
                                                <xsl:text>изменением площади земельного участка и (или) изменением описания местоположения его границ</xsl:text>
                                            </div>
                                        </div>
                                    </div>
                                </xsl:if>
                                <xsl:if test="$currentActionType = '111200003020'">
                                    <div class="row">
                                        <div class="table tablemargin">
                                            ...
                                            <div class="cell center w40 bold">V</div>
                                            <div class="cell leftpad wrap">
                                                <xsl:text>уточнением местоположения объекта недвижимости на земельном</xsl:text>
                                ...
                                <xsl:if test="$currentActionType = '111200003030'">
                                    <div class="row">
                                        <div class="table tablemargin">
                                            ...
                                            <div class="cell center w40 bold">V</div>
                                            <div class="cell leftpad wrap ">
                                                <xsl:text>изменением основной характеристики объекта недвижимости </xsl:text>
                                                <b>
                                ...
                                <xsl:if test="$currentActionType = '111200003060'">
                                    <div class="row">
                                        <div class="table tablemargin">
                                            ...
                                            <div class="cell center w40 bold">V</div>
                                            <div class="cell leftpad wrap">
                                                <xsl:text>приведением вида объекта недвижимости в соответствие с требованиями действующего законодательства</xsl:text>
                                            </div>
                                        </div>
                                    </div>
                                </xsl:if>
                                <xsl:if test="$currentActionType = '111200003070'">
                                    <div class="row">
                                        <div class="table tablemargin">
                                            ...
                                            <div class="cell center w40 bold">V</div>
                                            <div class="cell leftpad wrap">
                                                <xsl:text>изменением характеристики объекта недвижимости </xsl:text>
                                                <b>
                                                    <xsl:value-of select="tns:changingCharacteristics"/>
                                                </b>
                                                <!--xsl:if test="$cadastralActionCombined = '111200003030'">
                                ...
                                <xsl:if test="$currentActionType = '111200004000'">
                                    <div class="row">
                                        <div class="table tablemargin">
                                            <div class="cell center w40 bold">V</div>
                                            <div class="cell leftpad">
                                                <xsl:text>внесение сведений о ранее учтенном объекте</xsl:text>
                                            </div>
                                        </div>
                                    </div>
                                </xsl:if>
            ...
            <div class="table">
                <div class="row">
                    ...
                    <div class="cell clear">
                        <div class="table tablemargin">
                            <div class="row">
                                <div class="cell leftpad">В части государственной регистрации прав осуществить
                                    регистрацию:
                                </div>
                            </div>
                            <xsl:if test="$rightActionTypeCombined = '111100001000' or $rightActionType = '111100001000'">
                                <div class="row">
                                    <div class="table tablemargin">
                                        <div class="cell center w40 bold">V</div>
                                        <div class="cell leftpad wrap w300">
                                            <xsl:text>ранее возникшего (до 31.01.1998) права:</xsl:text>
                                        </div>
                            ...
                            <xsl:if test="$rightActionTypeCombined = '111100002000' or $rightActionType = '111100002000'">
                                <div class="row">
                                    <div class="table tablemargin">
                                        <div class="cell center w40 bold">V</div>
                            ...
                            <xsl:if test="$rightActionTypeCombined = '111100003000' or $rightActionType = '111100003000'">
                                <div class="row">
                                    <div class="table tablemargin">
                                        <div class="cell center w40 bold">V</div>
                                        <div class="cell leftpad w300">
                            ...
                            <xsl:if test="$rightActionTypeCombined = '111100004000' or $rightActionType = '111100004000'">
                                <div class="row">
                                    <div class="table tablemargin">
                                        <div class="cell center w40 bold">V</div>
                                        <div class="cell leftpad w300">
                            ...
                            <xsl:if test="$rightActionTypeCombined = '111100005000' or $rightActionType = '111100005000'">
                                <div class="row">
                                    <div class="table tablemargin">
                                        <div class="cell center w40 bold">V</div>
                                        <div class="cell leftpad w300 wrap">
                                            <xsl:text>ограничения права и (или) обременения объекта недвижимости:</xsl:text>
                                        </div>
                                        <div class="cell leftpad bold wrap">
                                            <xsl:call-template name="codeRightAction"/>
                                        </div>
                            ...
                            <xsl:if test="$rightActionTypeCombined = '111100006000' or $rightActionType = '111100006000'">
                                <div class="row">
                                    <div class="table tablemargin">
                                        <div class="cell center w40 bold">V</div>
                                        <div class="cell leftpad w300 wrap">
                                            <xsl:text>сделку об отчуждении объекта недвижимости или об ограничении (обременении) права:</xsl:text>
                                        </div>
                                        <div class="cell leftpad bold wrap">
                                            <xsl:call-template name="codeRightAction"/>
                                        </div>
                            ...
                            <xsl:if test="$rightActionTypeCombined = '111100007000' or $rightActionType = '111100007000'">
                                <div class="row">
                                    <div class="table tablemargin">
                                        <div class="cell center w40 bold">V</div>
                                        <div class="cell leftpad w300 wrap">
                                            <xsl:text>сделку об изменении или расторжении ранее совершенной сделки; соглашение об уступке права требования или переводе долга по ранее совершенной сделке:</xsl:text>
                                        </div>
                                        <div class="cell leftpad bold wrap">
                                            <xsl:call-template name="codeRightAction"/>
                                        </div>
                            ...
                            <xsl:if test="$rightActionTypeCombined = '111100008000' or $rightActionType = '111100008000'">
                                <div class="row">
                                    <div class="table tablemargin">
                                        <div class="cell center w40 bold">V</div>
                                        <div class="cell leftpad w300 wrap">
                                            <xsl:text>прекращения ограничения права и (или) обременения объекта недвижимости:</xsl:text>
                                        </div>
                                        <div class="cell leftpad bold wrap">
                                            <xsl:call-template name="codeRightAction"/>
                                        </div>
    ...
    <xsl:template name="codeRightAction">
        <xsl:call-template name="rightKindTemplate">
            <xsl:with-param name="rightKind" select="$rightKindCombined | $rightKind"/>
        </xsl:call-template>
        <xsl:call-template name="rightRestrictionsKindTemplate">
            <xsl:with-param name="rightRestrictionsKind"
    ...
    <xsl:template name="point71person">
        ...
        <div class="row">
            <div class="table tablemargin">
                <div class="cell center w220 wrap">документ, удостоверяющий личность:</div>
        ...
        <xsl:if test="$thisPerson/subj:contactInfo">
            <div class="row">
                <div class="table tablemargin">
                    ...
                    <div class="cell center w200 wrap">телефон для связи: (в том числе для уведомления о поступивших
                        заявлениях в отношении объекта недвижимости)
                    </div>
                    <div class="cell center wrap">адрес электронной почты: (в том числе для уведомления о поступивших
                        заявлениях в отношении объекта недвижимости)
                    </div>
                </div>
            </div>
                ...
                <div class="table tablemargin">
                    <div class="cell center w220 wrap bold">
                        <xsl:if test="$thisPerson/subj:contactInfo/subj:postalAddress">
                            <xsl:call-template name="createAddressTemplate">
                                <xsl:with-param name="pathToAddress"
                ...
                <div class="table tablemargin">
                    <div class="cell center w220 wrap bold">
                        <xsl:if test="$thisOrganization/subj:nativeForeignParams/subj:foreignOrgParams/subj:countryCode">
                            <xsl:call-template name="citizenCodeTemplate">
                                <xsl:with-param name="citizenCode"
            ...
            <div class="row">
                ...
                <xsl:choose>
                    <xsl:when test="normalize-space($tempRepFiltred)">
                        <div class="cell leftpad wrap">
                            <xsl:text>Представителем правообладателя, стороны сделки, лица, в пользу которого устанавливается ограничение права или обременение объекта, иным лицом, указанным в статье 15 Федерального закона от 13.07.2015 N 218-ФЗ "О государственной регистрации недвижимости"</xsl:text>
                        </div>
                    </xsl:when>
                    <xsl:otherwise>
                        <div class="cell leftpad wrap">
                            <xsl:text>Правообладателем, стороной сделки, лицом, в пользу которого устанавливается ограничение права или обременение объекта, лично</xsl:text>
                        </div>
                    </xsl:otherwise>
                </xsl:choose>
            </div>
    ...
    <xsl:template name="powerOfAttorney">
        ...
        <xsl:for-each select="$personRepresentDocs">
            ...
            <xsl:for-each select="//tns:header/stCom:appliedDocument/node()[@_id=$docID]">
                <xsl:call-template name="documentTemplate">
                    ...
                    <xsl:with-param name="last" select="boolean($pos = $personRepresentCount)"/>
                </xsl:call-template>
            </xsl:for-each>
        </xsl:for-each>
    </xsl:template>
            ...
            <div class="row">
                ...
                <div class="cell clear">
                    <div class="table tablemargin">
                        <!--div class="row"-->
                        <div class="cell leftpad wrap">
                            <xsl:text>Сведения о представителе правообладателя, стороны сделки, лица, в пользу которого устанавливается ограничение права или обременение объекта, об ином лице, указанном в статье 15 Федерального закона от 13.07.2015 N 218-ФЗ "О государственной регистрации недвижимости" - физическом лице (в том числе нотариусе, судебном приставе-исполнителе, кадастровом инженере):</xsl:text>
                        </div>
                        <!--/div-->
                        ...
                        <xsl:for-each select="$curPerson">
                            ...
                            <xsl:variable name="personRepresent" select="//tns:statementForm1/tns:subjects/descendant::subj:representative/subj:subject[@_id=$personID]"/>
                            <xsl:variable name="personRepresentDocs" select="$personRepresent/parent::node()/subj:representativeDocumentRef/@documentID/parent::node()"/>

                            <xsl:if test="count($personRepresentDocs) = 1">
                                <xsl:call-template name="powerOfAttorney">
                                    <xsl:with-param name="personRepresentDocs" select="$personRepresentDocs"/>
                                    <xsl:with-param name="personRepresentCount" select="count($personRepresent)"/>
                                </xsl:call-template>
                            </xsl:if>
                            <xsl:if test="count($personRepresentDocs) > 1">
                                <xsl:call-template name="powerOfAttorney">
                                    <xsl:with-param name="personRepresentDocs"  select="$personRepresentDocs[not(string(@documentID)=preceding::subj:representativeDocumentRef/@documentID)]"/>
                                    <xsl:with-param name="personRepresentCount" select="count($personRepresent)"/>
                                </xsl:call-template>
                            </xsl:if>
                        </xsl:for-each>
            ...
            <div class="row">
                ...
                <div class="cell clear">
                    <div class="table tablemargin">
                        <!--div class="row"-->
                        <div class="cell leftpad wrap">
                            <xsl:text>Сведения о представителе правообладателя, стороны сделки, лица, в пользу которого устанавливается ограничение права или обременение объекта, об ином лице, указанном в статье 15 Федерального закона от 13.07.2015 N 218-ФЗ "О государственной регистрации недвижимости" - юридическом лице (в том числе органе государственной власти, ином государственном органе, органе местного самоуправления):</xsl:text>
                        </div>
                        <!--/div-->
                        <!-- Цикличность возможно избыточна-->
                        <xsl:for-each select="$curPerson">
            ...
            <div class="row">
                ...
                <div class="cell clear">
                    <div class="table tablemargin">
                        <!--div class="row"-->
                        <div class="cell leftpad wrap">
                            <xsl:text>Сведения о представителе правообладателя, стороны сделки, лица, в пользу которого устанавливается ограничение права или обременение объекта, об ином лице, указанном в статье 15 Федерального закона от 13.07.2015 N 218-ФЗ "О государственной регистрации недвижимости" - Иное описание:</xsl:text>
                        </div>
                        <!--/div-->
                        <!-- Цикличность возможно избыточна-->
                        <xsl:for-each select="$curPerson">
    ...
    <xsl:template name="point9">
        <xsl:variable name="receiveMethod"
            ...
            <div class="table">
                <div class="row">
                    ...
                    <div class="cell clear">
                        <div class="table tablemargin">
                            <div class="row">
                                <div class="cell leftpad wrap">Способ представления заявления и иных необходимых для
                                    государственного кадастрового учета недвижимого имущества и (или) государственной
                                    регистрации прав на недвижимое имущество документов:
                                </div>
                            </div>
            ...
            <div class="table">
                <div class="row">
                    ...
                    <div class="cell clear">
                        <div class="table tablemargin">
                            <div class="row">
                                <div class="cell leftpad wrap">Для удостоверения проведенного государственного
                                    кадастрового учета и (или) государственной регистрации прав прошу:
                                </div>
                            </div>
                            <xsl:choose>
                                <xsl:when test="$deliveryMethod/stCom:receiveDischarge = 'true'">
                                    <div class="row">
                                        <div class="table tablemargin">
                                            <div class="cell center w40">
                                                <b>V</b>
                                            ...
                                            <div class="cell leftpad wrap">
                                                <xsl:text>выдать выписку из Единого государственного реестра недвижимости</xsl:text>
                                            </div>
                                        </div>
                                    </div>
                                </xsl:when>
    ...
    <xsl:template name="point14">
        <xsl:variable name="note14" select="//tns:statementForm1/tns:statementDetails/tns:note"/>
        <xsl:if test="$note14">
            <div class="table">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="table tablemargin">
                                <div class="cell leftpad wrap">
                                    ...
                                    <div class="table normal nospacing wrap justify lh-middle">
                                        <div class="row">
                                            <div class="cell nopadding noborder">сведения, указанные в настоящем
                                                заявлении, на дату представления заявления достоверны;
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table normal nospacing wrap justify lh-middle">
                                        <div class="row">
                                            <div class="cell nopadding noborder">представленные документы и содержащиеся
                                                в них сведения соответствуют установленным законодательством Российской
                                                Федерации требованиям, в том числе указанные сведения достоверны;
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table normal nospacing wrap justify lh-middle">
                                        <div class="row">
                                            <div class="cell nopadding noborder">при совершении сделки с объектом
                                                недвижимости соблюдены установленные законодательством Российской
                                                Федерации требования, в том числе в установленных законом случаях
                                                получено согласие (разрешение, согласование и т.п.) указанных в нем
                                                органов (лиц);
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table normal nospacing wrap justify lh-middle">
                                        <div class="row">
                                            <div class="cell nopadding noborder">мне известно о возможности привлечения
                                                меня в соответствии с законодательством Российской Федерации к
                                                ответственности (в том числе уголовной) за представление поддельных
                                                документов, в том числе документов, содержащих недостоверные сведения.
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="table">
            <div class="row">
                ...
                <div class="cell clear">
                    <div class="table tablemargin">
                        <div class="row">
                            <div class="cell leftpad wrap ">Даю свое согласие на участие в опросе по оценке качества
    ...
    <xsl:template name="point18">
        ...
        <xsl:variable name="tempOwners" select="(//tns:statementForm1/tns:subjects/descendant::subj:owner)"/>
        ...
        <xsl:variable name="ownerIdList">
            <xsl:for-each select="//tns:statementForm1/tns:subjects/tns:owners/tns:owner">
                <xsl:if test="subj:person | subj:previligedPerson">
    ...
    <xsl:template name="createAddressTemplate">
        ...
        <xsl:if test="not(($nameOrgan!='') and ($pathToAddress/adr:note!=''))">
            ...
            <xsl:if test="string($pathToAddress/adr:region/adr:code)">
                ...
                <xsl:if test="$pathToAddress/adr:autonomy or $pathToAddress/adr:district or $pathToAddress/adr:city or $pathToAddress/adr:urbanDistrict or $pathToAddress/adr:locality or $pathToAddress/adr:street or $pathToAddress/adr:additionalElement or $pathToAddress/adr:subordinateElement or $pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:autonomy/adr:code)">
                ...
                <xsl:if test="$pathToAddress/adr:district or $pathToAddress/adr:city or $pathToAddress/adr:urbanDistrict or $pathToAddress/adr:locality or $pathToAddress/adr:street or $pathToAddress/adr:additionalElement or $pathToAddress/adr:subordinateElement or $pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:district/adr:name)">
                ...
                <xsl:if test="$pathToAddress/adr:city or $pathToAddress/adr:urbanDistrict or 	$pathToAddress/adr:locality or $pathToAddress/adr:street or $pathToAddress/adr:additionalElement or $pathToAddress/adr:subordinateElement or $pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:city/adr:name)">
                <xsl:value-of select="$pathToAddress/adr:city/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:city/adr:name"/>
                <xsl:if test="$pathToAddress/adr:urbanDistrict or 	$pathToAddress/adr:locality or $pathToAddress/adr:street or $pathToAddress/adr:additionalElement or $pathToAddress/adr:subordinateElement or $pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:urbanDistrict/adr:name)">
                ...
                <xsl:if test="$pathToAddress/adr:locality or $pathToAddress/adr:street or $pathToAddress/adr:additionalElement or $pathToAddress/adr:subordinateElement or $pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:locality/adr:name)">
                <xsl:value-of select="$pathToAddress/adr:locality/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:locality/adr:name"/>
                <xsl:if test="$pathToAddress/adr:street or $pathToAddress/adr:additionalElement or $pathToAddress/adr:subordinateElement or $pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:street/adr:name)">
                <xsl:value-of select="$pathToAddress/adr:street/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:street/adr:name"/>
                <xsl:if test="$pathToAddress/adr:additionalElement or $pathToAddress/adr:subordinateElement or $pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:additionalElement/adr:name)">
                <xsl:value-of select="$pathToAddress/adr:additionalElement/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:additionalElement/adr:name"/>
                <xsl:if test="$pathToAddress/adr:subordinateElement or $pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:subordinateElement/adr:name)">
                <xsl:value-of select="$pathToAddress/adr:subordinateElement/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:subordinateElement/adr:name"/>
                <xsl:if test="$pathToAddress/adr:house or $pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:house)">
                <xsl:value-of select="$pathToAddress/adr:house/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:house/adr:value"/>
                <!--xsl:value-of select="$pathToAddress/adr:house"/-->
                <xsl:if test="$pathToAddress/adr:building or $pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:building)">
                <xsl:value-of select="$pathToAddress/adr:building/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:building/adr:value"/>
                <xsl:if test="$pathToAddress/adr:structure or $pathToAddress/adr:apartment or $pathToAddress/adr:other">
                    ,
                </xsl:if>
            </xsl:if>
            <xsl:if test="string($pathToAddress/adr:structure)">
                <xsl:value-of select="$pathToAddress/adr:structure/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:structure/adr:value"/>
            ...
            <xsl:if test="string($pathToAddress/adr:apartment/adr:name)">
                <xsl:value-of select="$pathToAddress/adr:apartment/adr:type"/>&nbsp;<xsl:value-of
                    select="$pathToAddress/adr:apartment/adr:name"/>
    ...
    <xsl:template name="rightKindTemplate">
        ...
        <xsl:value-of select="$rightKindEnum//xs:enumeration[@value=$rightKind]/xs:annotation/xs:documentation"/>
    </xsl:template>
    <xsl:template name="rightRestrictionsKindTemplate">
        ...
        <xsl:variable name="rightRestrictionsKindEnum" select="document($dictPath)"/>        
        <xsl:value-of
    ...
    <xsl:template name="dealCodeTemplate">
        ...
        <xsl:value-of select="$dealCodeEnum//xs:enumeration[@value=$dealCode]/xs:annotation/xs:documentation"/>
    </xsl:template>
                ...
                <div class="table tablemargin">
                    <xsl:if test="$mode1 = 'representative'">
                        <xsl:if test="$first">
                            <xsl:choose>
                                <xsl:when test="$last">
                                    <div class="cell center w220 wrap">наименование и реквизиты документа,
                                        подтверждающего
                                        полномочия представителя:
                                    </div>
                                </xsl:when>
                                <xsl:otherwise>
                                    <div class="cell cell-top center w220 wrap">наименование и реквизиты документа,
                                        подтверждающего
                                        полномочия представителя:
                                    </div>
                                </xsl:otherwise>
                    ...
                    <div class="cell left wrap">
                        <b>
                            ...
                            <xsl:if test="$thisDocument/doc:name">
                                ...
                                <xsl:if test="$thisDocument/doc:series or $thisDocument/doc:number or $thisDocument/doc:issueDate or $thisDocument/doc:attachment/doc:desc or $thisDocument/doc:notes or $thisDocument/doc:issuer/doc:name or $thisDocument/doc:durationStart or $thisDocument/doc:durationStop or $thisDocument/doc:notaryInfo">
                                    ,
                                </xsl:if>
                            </xsl:if>
                            ...
                            <xsl:if test="$thisDocument/doc:series">
                                ...
                                <xsl:if test="$thisDocument/doc:number or $thisDocument/doc:issueDate or $thisDocument/doc:attachment/doc:desc or $thisDocument/doc:notes or $thisDocument/doc:issuer/doc:name or $thisDocument/doc:durationStart or $thisDocument/doc:durationStop or $thisDocument/doc:notaryInfo">
                                    ,
                                </xsl:if>
                            </xsl:if>
                            <xsl:if test="normalize-space($thisDocument/doc:number)">
                                ...
                                <xsl:if test="$thisDocument/doc:issueDate or $thisDocument/doc:attachment/doc:desc or $thisDocument/doc:notes or $thisDocument/doc:issuer/doc:name or $thisDocument/doc:durationStart or $thisDocument/doc:durationStop or $thisDocument/doc:notaryInfo">
                                    ,
                                </xsl:if>
                            </xsl:if>
                            <xsl:if test="$thisDocument/doc:issueDate">
                                ...
                                <xsl:if test="$thisDocument/doc:attachment/doc:desc or $thisDocument/doc:notes or $thisDocument/doc:issuer/doc:name or $thisDocument/doc:durationStart or $thisDocument/doc:durationStop or $thisDocument/doc:notaryInfo">
                                    ,
                                </xsl:if>
                            </xsl:if>
                            <xsl:if test="$thisDocument/doc:attachment/doc:desc">
                                ...
                                <xsl:if test="$thisDocument/doc:attachment/doc:fileDesc/doc:file/doc:fileSize or $thisDocument/doc:notes or $thisDocument/doc:issuer/doc:name or $thisDocument/doc:durationStart or $thisDocument/doc:durationStop or $thisDocument/doc:notaryInfo">
                                    ,
                                </xsl:if>
                            </xsl:if>
                            <xsl:if test="$thisDocument/doc:attachment/doc:fileDesc/doc:file/doc:fileSize">
                                ...
                                <xsl:if test="$thisDocument/doc:notes or $thisDocument/doc:issuer/doc:name or $thisDocument/doc:durationStart or $thisDocument/doc:durationStop or $thisDocument/doc:notaryInfo">
                                    ,
                                </xsl:if>
                            </xsl:if>
                            <xsl:if test="$thisDocument/doc:notes">
                                ...
                                <xsl:if test="$thisDocument/doc:issuer/doc:name or $thisDocument/doc:durationStart or $thisDocument/doc:durationStop or $thisDocument/doc:notaryInfo">
                                    ,
                                </xsl:if>
                            </xsl:if>
                            <xsl:if test="$thisDocument/doc:issuer/doc:name">
                                <xsl:value-of select="$thisDocument/doc:issuer/doc:name"/>
                                <xsl:if test="$thisDocument/doc:durationStart or $thisDocument/doc:durationStop or $thisDocument/doc:notaryInfo">
                                    ,
                                </xsl:if>
                            </xsl:if>
