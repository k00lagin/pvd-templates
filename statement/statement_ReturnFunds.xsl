...
<!-- Версия для ПК ПВД TODO: проверить форматирование для PDF-->
	...
	<!-- Заявители -->
	<xsl:variable name="operson" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:person"/>
	<xsl:variable name="opersonPrevileg" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:previligedPerson"/>
	<xsl:variable name="oorganization" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:organization"/>
	<xsl:variable name="ocountry" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:country"/>
	<xsl:variable name="orfSubject" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:rfSubject"/>
	<xsl:variable name="oother" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:other"/>
	<!-- Представители 1го уровня -->
	<xsl:variable name="orperson" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:person"/>
	<xsl:variable name="orpersonPrevileg" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:previligedPerson"/>
	<xsl:variable name="ororganization" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:organization"/>
	<xsl:variable name="orcountry" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:country"/>
	<xsl:variable name="orrfSubject" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:rfSubject"/>
	<xsl:variable name="orother" select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant/subj:representative/subj:subject/subj:other"/>
	...
	<xsl:variable name="tempRepresent" select="(//tns:statementFormReturnOfFunds/tns:subjects/descendant::subj:representative/subj:subject)"/>
	<xsl:variable name="tempRepFiltred" select="$tempRepresent/self::node()[not(@_id=preceding::subj:subject/@_id)]"/>

	<xsl:variable name="nameOrganInner" select="tns:statementFormReturnOfFunds/tns:deliveryDetails/stCom:requestDeliveryMethod/stCom:regRightAuthority"/>
	...
	<xsl:template name="point1">
		...
		<div id="wrapperClear">
			...
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						<xsl:text>Прошу  возвратить  излишне оплаченную сумму за предоставление сведений,
							содержащихся   в   Едином  государственном  реестре  недвижимости,  и  иной
							информации в размере
						</xsl:text>
						<xsl:apply-templates select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:sizeExcessivelyPaidAmount/doc:amount"/>	
						...
						<br/>		
						<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:sizeExcessivelyPaidAmount/doc:amountWords"/>	
					</div>
				</div>
			</div>
			<div class="table">
			...
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						...
						<xsl:for-each select="//tns:statementFormReturnOfFunds/tns:objects/stCom:object/obj:address">
						...
						<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:objects/stCom:object/obj:cadastralNumber/obj:cadastralNumber"/>	
					</div>
				</div>
			</div>
			<div class="table">
				<div class="row">
					<div class="cell clear  topborder  wrap center">
						<div style=" font-size: 80%;">
							<xsl:text>(Адрес объекта недвижимости, кадастровый номер)</xsl:text>
						</div>	
					</div>
				</div>
			</div>
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						...
						<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:reasonReturn"/>	
					</div>
				</div>
			</div>
			<div class="table">
			...
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						<xsl:text>Прошу перечислить деньги на счет, открытый в банке:</xsl:text>
						<br/>
			...
			<div class="table tablemargin">
				<div class="row">
					...
					<xsl:variable name="accountNum" select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:bankDetails/doc:settlementAccount"/>
			...
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						...
						<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:bankDetails/doc:roomOffice"/>	
					</div>
				</div>
			</div>
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						...
						<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:bankDetails/doc:bankName"/>	
					</div>
				</div>
			</div>
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						...
						<xsl:call-template name="createAddressTemplate">
							<xsl:with-param name="pathToAddress" select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:bankDetails/doc:address"/>
						</xsl:call-template>
					</div>
				</div>
			</div>
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						...
						<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:bankDetails/doc:BIC"/>	
					</div>
				</div>
			</div>
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						...
						<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:bankDetails/doc:correspondentAccount"/>	
					</div>
				</div>
			</div>
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						...
						<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:bankDetails/doc:INN"/>	
					</div>
				</div>
			</div>
			<br/>
			...
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						<xsl:if test="not(//tns:statementFormReturnOfFunds/tns:header/stCom:appliedDocument/doc:paymentDocument)">
							<xsl:text>К заявлению не прилагаю по собственной инициативе платежный документ</xsl:text>
						</xsl:if>
						<xsl:if test="//tns:statementFormReturnOfFunds/tns:header/stCom:appliedDocument/doc:paymentDocument">
							<xsl:text>К заявлению прилагаю по собственной инициативе </xsl:text>
							<xsl:for-each select="//stCom:appliedDocument/doc:paymentDocument">
								...
								<xsl:if test="not(doc:attachment/doc:receivedInPaper/doc:original)">
			...
			<div class="table">
				<div class="row">
					<div class="cell clear wrap">
						<xsl:text>№ запроса о предоставлении сведений (при наличии): </xsl:text>
						 <u>
							<xsl:if test="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:originalRequest/tns:previousStatementKUVDNumber">
								<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:originalRequest/tns:previousStatementKUVDNumber"/>	
							</xsl:if>	
							<xsl:if test="not(//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:originalRequest/tns:previousStatementKUVDNumber)">
								<xsl:text>&nbsp;&nbsp;&mdash;&nbsp;&nbsp;</xsl:text>
							</xsl:if>	
						</u>
						<xsl:text>&nbsp; от </xsl:text>
						 <u>
							<xsl:if test="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:originalRequest/tns:statementRegDate">
								<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:originalRequest/tns:statementRegDate"/>	
							</xsl:if>	
							<xsl:if test="not(//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:originalRequest/tns:statementRegDate)">
								<xsl:text>&nbsp;&nbsp;&mdash;&nbsp;&nbsp;</xsl:text>
							</xsl:if>	
						</u>
					</div>
				...
				<div class="row">
					<div class="cell clear wrap">
						<xsl:text>№ идентификации кода платежа (при наличии): </xsl:text>
						 <u>
							<xsl:if test="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:identificationCodePayment/doc:number">
								<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:identificationCodePayment/doc:number"/>	
							</xsl:if>	
							<xsl:if test="not(//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:identificationCodePayment/doc:number)">
								<xsl:text>&nbsp;&nbsp;&mdash;&nbsp;&nbsp;</xsl:text>
							</xsl:if>	
						</u>
						<xsl:text>&nbsp; от </xsl:text>
						 <u>
							<xsl:if test="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:identificationCodePayment/doc:date">
								<xsl:value-of select="//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:identificationCodePayment/doc:date"/>	
							</xsl:if>	
							<xsl:if test="not(//tns:statementFormReturnOfFunds/tns:statementDetails/tns:returnOfFunds/tns:identificationCodePayment/doc:date)">
								<xsl:text>&nbsp;&nbsp;&mdash;&nbsp;&nbsp;</xsl:text>
							</xsl:if>	
						</u>
					</div>
			...
			<xsl:variable name="declarantIdList"> 
				  <xsl:for-each select="//tns:statementFormReturnOfFunds/tns:subjects/tns:declarant"> 
...
-->
	...
	<xsl:template name="point71person">
		...
		<xsl:variable name="subjDoc" select="//tns:statementFormReturnOfFunds/tns:header/stCom:appliedDocument/node()[@_id=$thisPerson/subj:idDocumentRef/@documentID]"/>
		...
		<br/>
		<div style=" font-size: 80%;">
			<xsl:text>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  (Ф.И.О. физического лица)</xsl:text>
		</div>	
	...
	<xsl:template name="point72organization">
		...
		<br/>
		<div style=" font-size: 80%;">
			<xsl:text>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  (наименование юридического лица)</xsl:text>
		</div>	
