...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template name="Footer">
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				<td class="note">
					(должность уполномоченного должностного лица органа, осуществляющего
		...
		<center>
			<div style="font-size: small">
				<span class="sr">
					Получение заявителем выписки из ЕГРП для последующего предоставления в
					органы государственной власти, органы местного самоуправления и органы
					государственных внебюджетных фондов в целях получения государственных
					и муниципальных услуг
				</span>
				<b>
					<span class="sr"> не требуется. </span>
				</b>
				<span class="sr"> Данную информацию указанные органы </span>
				<b>
					<span class="sr"> обязаны </span>
				</b>
				<span class="sr"> запрашивать у Росреестра </span>
				<b>самостоятельно. </b>
				(Федеральный закон от 27.07.2010 №210-ФЗ "Об организации предоставления
				государственных и муниципальных услуг", ч.1, ст.7)
			</div>
		</center>
		<div style="font-size: x-small">
			<xsl:choose>
				<xsl:when test="$Footer/ExtractRegion/Region">
					<br />
					<xsl:text
						>Сведения сформированы по информации предоставленной следующими
						управлениями Росреестра:</xsl:text
					>
					<br />
