...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template
		match="Reestr_Extract_Subject[eDocument[@Version='01']] | Reestr_Extract[eDocument[@Version='01'] and (//ExtractSubjectRight or //Reestr_Extract//ExtractSubjectRightRefusal)]"
	>
		<html>
			<head>
