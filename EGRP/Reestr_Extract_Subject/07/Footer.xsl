    ...
    <p>
      <xsl:choose>
        <xsl:when test="$Footer/ExtractRegion/Region and $IsExstract=1"> 
          ...
          <xsl:text>Выписка содержит сведения Единого государственного реестра недвижимости о правах на объекты недвижимости, расположенные на территории субъектов(а) Российской Федерации, указанных(ого) Вами в запросе (территориальный орган,  осуществляющий функции по государственной регистрации прав на недвижимое имущество и сделок с ним, государственному кадастровому учету недвижимого имущества на подведомственной территории – </xsl:text>
