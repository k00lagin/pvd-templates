						...
						<div class="NoticeHeaderDept">
							...
							<div style="font-size: small">
								...
								<xsl:call-template name="Value">
									<xsl:with-param
										name="Node"
										select="HeadContent/DeptShortName"
									/>
								</xsl:call-template>
								<b>)</b>
							</div>
							<div style="font-size: small">
								<xsl:call-template name="Value">
									<xsl:with-param
										name="Node"
										select="HeadContent/DeptAddress"
									/>
								</xsl:call-template>
							</div>
							<div style="font-size: small">
					...
					<td class="vc">
						<p>
							<xsl:call-template name="Value">
								<xsl:with-param
									name="Node"
									select="ReceiveAttribute/ReceivName"
								/>
							</xsl:call-template>
							<xsl:if test="ReceiveAttribute/Representativ">
								...
								<xsl:call-template name="Value">
									<xsl:with-param
										name="Node"
										select="ReceiveAttribute/Representativ"
									/>
								</xsl:call-template>
								<xsl:text>)</xsl:text>
							</xsl:if>
						...
						<p>
							<xsl:if
								test="ReceiveAttribute/ReceivAdress/ReceivAdres/@PostIndex"
							>
								<xsl:text>индекс: </xsl:text>
								<xsl:call-template name="Value">
									<xsl:with-param
										name="Node"
										select="ReceiveAttribute/ReceivAdress/ReceivAdres/@PostIndex"
									/>
								</xsl:call-template>
							</xsl:if>
							<br />
							<xsl:if test="ReceiveAttribute/ReceivAdress/ReceivAdres/@Address">
								...
								<xsl:call-template name="Value">
									<xsl:with-param
										name="Node"
										select="ReceiveAttribute/ReceivAdress/ReceivAdres/@Address"
									/>
								</xsl:call-template>
							</xsl:if>
						</p>
				...
				<tr>
					...
					<td align="right" class="ul">
						<xsl:call-template name="Value">
							<xsl:with-param
								name="Node"
								select="DeclarAttribute/NoticeNumber"
							/>
						</xsl:call-template>
					</td>
				</tr>
