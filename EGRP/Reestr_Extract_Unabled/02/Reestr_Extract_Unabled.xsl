...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="Reestr_Extract_Unabled[eDocument[@Version='02']]">
		<html>
			<head>
				<title>Выписка о признании правообладателя недееспособным или ограниченно дееспособным (версия 02)</title>
			</head>
			<body lang="RU">
