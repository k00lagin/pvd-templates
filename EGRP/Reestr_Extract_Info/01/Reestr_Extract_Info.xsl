...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template
		match="Reestr_Extract_Info[eDocument[@Version='01']] | Reestr_Extract[eDocument[@Version='01'] and (//ExtractRightSbj or //ExtractRefusal/Name)]"
	>
		<html>
			<head>
				<title>
				...
				<div style="width: 17cm; text-align: justify">
					<xsl:choose>
						<xsl:when test="//ReestrExtract/ExtractRightSbj">
							...
							<p align="center">
								<b
									>СПРАВКА<br />О ЛИЦАХ, ПОЛУЧИВШИХ СВЕДЕНИЯ ОБ ОБЪЕКТЕ
									НЕДВИЖИМОГО<br />ИМУЩЕСТВА</b
								>
							</p>
							...
							<p>
								...
								<xsl:value-of
									select="//ExtractRightSbj/Time_lag/Initial_Date"
								/>
							...
							<table border="1" cellpadding="2" cellspacing="0" width="100%">
								...
								<xsl:variable
									name="rows"
									select="count(//ExtractRightSbj/ObjectRight/SubjectRecords/SubjectRecord)*3+1"
								/>
								<tr valign="top">
								...
								<xsl:for-each
									select="//ExtractRightSbj/ObjectRight/SubjectRecords/SubjectRecord"
								>
									<tr valign="top">
										<td rowspan="3">2.<xsl:value-of select="position()" /></td>
										<td>
											лицо, получившее информацию об объекте недвижимого
											имущества:
										</td>
										<td>
							...
							<xsl:choose>
								...
								>
									...
									<p>
										<xsl:call-template name="Request" />
										<xsl:text
											>, сообщаем, что сведения об объекте недвижимого
											имущества:</xsl:text
										>
									</p>
									<table
								...
								<xsl:otherwise>
									...
									>
										...
										<tr valign="top">
											...
											<td>
												справка о лицах, получивших сведения об объекте
