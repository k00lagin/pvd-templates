				...
				<xsl:for-each select="ExttRecepientDetail|ExttRecepientText">
							...
							<xsl:call-template name="Panel">
								<xsl:with-param name="Text">
									<xsl:call-template name="Value">
										<xsl:with-param
											name="Node"
											select="../ExttDate[position()=$RecipientIndex]"
										/>
									</xsl:call-template>
								</xsl:with-param>
							</xsl:call-template>
					...
					<tr>
						<td>
							<xsl:call-template name="Panel">
								<xsl:with-param name="Text">
									<xsl:text>исходящий номер выписки (справки):</xsl:text>
								</xsl:with-param>
							</xsl:call-template>
						</td>
						<td>
							<xsl:call-template name="Panel">
								<xsl:with-param name="Text">
									<xsl:call-template name="Value">
										<xsl:with-param
											name="Node"
											select="../ExtractNumber[position()=$RecipientIndex]"
										/>
									</xsl:call-template>
								</xsl:with-param>
							</xsl:call-template>
			...
			<xsl:when test="name($Owners)='Owner'">
				<xsl:for-each select="$Rights">
					<tr>
						...
						<xsl:variable
							name="RightOwners"
							select="$Owners[@OwnerNumber=$RightIndex]"
						/>
