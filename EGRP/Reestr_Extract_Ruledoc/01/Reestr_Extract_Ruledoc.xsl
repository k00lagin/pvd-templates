...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="Reestr_Extract_RuleDoc[eDocument[@Version='01']] | Reestr_Extract[eDocument[@Version='01'] and (//ExtractRightDoc or //ExtractRefusal/Name)]">
		<html>
			<head>
				<title>Справка о содержании правоустанавливающих документов (версия 01)</title>
			</head>
			<body lang="RU">
						...
						<xsl:when test="//ReestrExtract/ExtractRightDoc">
							...
							<xsl:for-each select="//ExtractRightDoc/ObjectRight">
								<table border="1" cellpadding="2" cellspacing="0" width="100%">
									...
									<xsl:variable name="Owners" select="count(RegistryRecords/Right/Owner)"/>
