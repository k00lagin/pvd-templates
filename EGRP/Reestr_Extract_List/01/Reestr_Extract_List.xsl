...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="Reestr_Extract_List[eDocument[@Version='01']] | Reestr_Extract[eDocument[@Version='01'] and count(//ExtractObjectRight/RightAssert) = 0 and count(//ExtractObjectRightRefusal/RightAssert) = 0 and (//ExtractObjectRight or //ExtractObjectRightRefusal)]">
		<html>
			<head>
				<title>Выписка о переходе прав на объект недвижимого имущества (версия 01)</title>
			</head>
			<body lang="RU">
